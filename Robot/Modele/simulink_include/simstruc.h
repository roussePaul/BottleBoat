...
struct _ssSizes {
  ...
  struct {
      ...
      unsigned int reserved:          4; /* remainder are reserved        */
  } flags;
...
typedef struct _ssICAttribs_tag {
    ...
    boolean_T computeInInitialize;
    boolean_T computeInEnable; 
} _ssICAttribs;
# define ssSetOutputPortICAttributes(S, pIdx, value1, value2, value3, value4, value5) \
    {  _ssICAttribs val = {value1, value2, value3, value4, value5};            \
