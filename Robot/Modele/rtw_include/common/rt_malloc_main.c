...
#ifndef RT_MALLOC
# error "rt_malloc_main.c require RT_MALLOC to be defined"
#endif
 ...
 * External functions *
 *====================*/
extern RT_MDL *MODEL(void);
extern void MODEL_INITIALIZE(RT_MDL  *S);
extern void MODEL_TERMINATE(RT_MDL  *S);

#if !defined(MULTITASKING)
extern void MODEL_STEP(RT_MDL *S);       /* single-rate step function */
#else
extern void MODEL_STEP(RT_MDL *S, int_T tid);  /* multirate step function */
#endif
 ...
 *   modifications.
 */
static void rt_OneStep(RT_MDL *S)
{
