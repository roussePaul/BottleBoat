...
typedef enum
{
    STATE_ENTER_ENTRY_FUNCTION_TAG=0
        ...
        ,MESSAGE_POST_BREAKPOINT_TAG=0
        ,MESSAGE_PEEK_BREAKPOINT_TAG
        ,MESSAGE_CONSUME_BREAKPOINT_TAG
        ,TOTAL_MESSAGE_TAGS
...
LIBMWSF_RUNTIME_API void sf_debug_set_chart_state_substate_index(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber,
                                                                 ...
                                                                 unsigned int subStateIndex,
                                                                 unsigned int subStateNumber);
LIBMWSF_RUNTIME_API void sf_debug_read_before_write_check(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber,
                                                          unsigned int chartNumber,
                                                          unsigned int instanceNumber,
                                                          unsigned int dataNumber,
                                                          bool isWritten);

LIBMWSF_RUNTIME_API void sf_debug_data_range_error(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber,
                                                   unsigned int chartNumber,
                                                   unsigned int instanceNumber,
                                                   unsigned int dataNumber);
...
LIBMWSF_RUNTIME_API void sf_debug_matrix_matrix_index_check(struct SfDebugInstanceStruct* debugInstance, const int* dims1, int nDims1, const int* dims2, int nDims2);
LIBMWSF_RUNTIME_API void sf_debug_vector_vector_index_check(struct SfDebugInstanceStruct* debugInstance, int sizeL_0, int sizeL_1, int sizeR_0, int sizeR_1);
...
LIBMWSF_RUNTIME_API void sf_debug_transition_conflict_error(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber,
                                                            unsigned int chartNumber,
                                                            unsigned int instanceNumber,
...
LIBMWSF_RUNTIME_API unsigned int sf_debug_temporal_threshold(struct SfDebugInstanceStruct* debugInstance, unsigned int machineNumber,
                                                             ...
                                                             SfDebugObjectType objectType,
                                                             unsigned int  objectNumber);
LIBMWSF_RUNTIME_API unsigned int sf_debug_data_range_check_enabled(struct SfDebugInstanceStruct* debugInstance);
LIBMWSF_RUNTIME_API unsigned int sf_debug_transition_conflict_check_enabled(struct SfDebugInstanceStruct* debugInstance);
LIBMWSF_RUNTIME_API void sf_debug_transition_conflict_check_begin(struct SfDebugInstanceStruct* debugInstance);
LIBMWSF_RUNTIME_API void sf_debug_transition_conflict_check_end(struct SfDebugInstanceStruct* debugInstance);
...
LIBMWSF_RUNTIME_API void sf_debug_overflow_detection(struct SfDebugInstanceStruct* debugInstance, SfDebugOverflowType type);
