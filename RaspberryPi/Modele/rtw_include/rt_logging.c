...
/* LocalWords:  Tfinal MAXNAM nonfinite Type Tfinal MAXNAM nonfinite Type DType
 * LocalWords:  RSim Fixup logvar DDEFAULT curr Realloc realloc inp NUL biglong
 * LocalWords:  vijay ldexp TXY eof
 */
