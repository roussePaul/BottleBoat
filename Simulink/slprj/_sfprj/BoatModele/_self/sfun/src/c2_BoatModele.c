...
static void initialize_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static void initialize_params_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static void enable_c2_BoatModele(SFc2_BoatModeleInstanceStruct *chartInstance);
static void disable_c2_BoatModele(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_BoatModele(SFc2_BoatModeleInstanceStruct *
  chartInstance);
static void set_sim_state_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_BoatModele(SFc2_BoatModeleInstanceStruct *chartInstance);
static void sf_gateway_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static void initSimStructsc2_BoatModele(SFc2_BoatModeleInstanceStruct
  *chartInstance);
static void c2_modeleBoat(SFc2_BoatModeleInstanceStruct *chartInstance,
  c2_srLgvkCzuuZn3rWrmrpDanB *c2_par);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_X_dot_ext, const char_T *c2_identifier, real_T c2_y[9]);
static void c2_b_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[3]);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[4]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_f_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[16]);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_h_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_g_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[9]);
static void c2_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_h_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[12]);
static void c2_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_i_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_i_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
...
static real_T c2_abs(SFc2_BoatModeleInstanceStruct *chartInstance, real_T c2_x);
static real_T c2_log(SFc2_BoatModeleInstanceStruct *chartInstance, real_T c2_x);
static void c2_eml_error(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_eml_scalar_eg(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_threshold(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_cross(SFc2_BoatModeleInstanceStruct *chartInstance, real_T c2_a[3],
                     real_T c2_b[3], real_T c2_c[3]);
static real_T c2_atan2(SFc2_BoatModeleInstanceStruct *chartInstance, real_T c2_y,
  real_T c2_x);
static void c2_c_eml_scalar_eg(SFc2_BoatModeleInstanceStruct *chartInstance);
static real_T c2_mpower(SFc2_BoatModeleInstanceStruct *chartInstance, real_T
  c2_a);
static real_T c2_sqrt(SFc2_BoatModeleInstanceStruct *chartInstance, real_T c2_x);
static void c2_b_eml_error(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_d_eml_scalar_eg(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_mldivide(SFc2_BoatModeleInstanceStruct *chartInstance, real_T
  c2_A[16], real_T c2_B[4], real_T c2_Y[4]);
static void c2_eml_switch_helper(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_eml_matlab_zgetrf(SFc2_BoatModeleInstanceStruct *chartInstance,
  real_T c2_A[16], real_T c2_b_A[16], int32_T c2_ipiv[4], int32_T *c2_info);
static int32_T c2_eml_ixamax(SFc2_BoatModeleInstanceStruct *chartInstance,
  int32_T c2_n, real_T c2_x[16], int32_T c2_ix0);
static void c2_check_forloop_overflow_error(SFc2_BoatModeleInstanceStruct
  *chartInstance, boolean_T c2_overflow);
static void c2_b_threshold(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_eml_xgeru(SFc2_BoatModeleInstanceStruct *chartInstance, int32_T
  c2_m, int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T
  c2_A[16], int32_T c2_ia0, real_T c2_b_A[16]);
static void c2_eml_warning(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_c_threshold(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_scalarEg(SFc2_BoatModeleInstanceStruct *chartInstance);
static void c2_eml_xtrsm(SFc2_BoatModeleInstanceStruct *chartInstance, real_T
  c2_A[16], real_T c2_B[4], real_T c2_b_B[4]);
static const mxArray *c2_j_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_j_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_i_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_k_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_BoatModele, const char_T
  *c2_identifier);
static uint8_T c2_l_emlrt_marshallIn(SFc2_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_log(SFc2_BoatModeleInstanceStruct *chartInstance, real_T *c2_x);
static void c2_b_sqrt(SFc2_BoatModeleInstanceStruct *chartInstance, real_T *c2_x);
static void c2_b_eml_matlab_zgetrf(SFc2_BoatModeleInstanceStruct *chartInstance,
  real_T c2_A[16], int32_T c2_ipiv[4], int32_T *c2_info);
static void c2_b_eml_xgeru(SFc2_BoatModeleInstanceStruct *chartInstance, int32_T
  c2_m, int32_T c2_n, real_T c2_alpha1, int32_T c2_ix0, int32_T c2_iy0, real_T
  c2_A[16], int32_T c2_ia0);
static void c2_b_eml_xtrsm(SFc2_BoatModeleInstanceStruct *chartInstance, real_T
  c2_A[16], real_T c2_B[4]);
static void init_dsm_address_info(SFc2_BoatModeleInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_BoatModele = 0U;
}
  ...
  chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_BoatModele;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_BoatModele = c2_k_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_BoatModele");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_BoatModele(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_BoatModele(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[9];
  const mxArray *c2_y = NULL;
  SFc2_BoatModeleInstanceStruct *chartInstance;
  chartInstance = (SFc2_BoatModeleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_BoatModele_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_l_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_BoatModele), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_BoatModele);
  return c2_y;
}
...
void sf_c2_BoatModele_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_BoatModele_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_BoatModele_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_BoatModele_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_BoatModele(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"X_dot_ext\",},{M[8],M[0],T\"is_active_c2_BoatModele\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_BoatModele_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_BoatModeleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c2_BoatModele(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_BoatModeleInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_BoatModele((SFc2_BoatModeleInstanceStruct*)
    chartInstanceVar);
  initialize_c2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_BoatModele(void *chartInstanceVar)
{
  enable_c2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_BoatModele(void *chartInstanceVar)
{
  disable_c2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_BoatModele(void *chartInstanceVar)
{
  sf_gateway_c2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_BoatModele(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_BoatModele
    ((SFc2_BoatModeleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_BoatModele();/* state var info */
...
extern void sf_internal_set_sim_state_c2_BoatModele(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c2_BoatModele();/* state var info */
  ...
  set_sim_state_c2_BoatModele((SFc2_BoatModeleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_BoatModele(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_BoatModele(S);
}

static void sf_opaque_set_sim_state_c2_BoatModele(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c2_BoatModele(S, st);
}

static void sf_opaque_terminate_c2_BoatModele(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_BoatModeleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_BoatModele((SFc2_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_BoatModele(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_BoatModele(SimStruct *S)
{
  SFc2_BoatModeleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_BoatModeleInstanceStruct *)utMalloc(sizeof
    (SFc2_BoatModeleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_BoatModeleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_BoatModele;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_BoatModele;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_BoatModele;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_BoatModele;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_BoatModele;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_BoatModele;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_BoatModele;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_BoatModele;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_BoatModele;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_BoatModele;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_BoatModele;
...
void c2_BoatModele_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_BoatModele(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_BoatModele(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_BoatModele(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_BoatModele_method_dispatcher.\n"
