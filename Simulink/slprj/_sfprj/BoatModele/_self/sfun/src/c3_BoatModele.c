...
static void initialize_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static void initialize_params_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static void enable_c3_BoatModele(SFc3_BoatModeleInstanceStruct *chartInstance);
static void disable_c3_BoatModele(SFc3_BoatModeleInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_BoatModele(SFc3_BoatModeleInstanceStruct *
  chartInstance);
static void set_sim_state_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_BoatModele(SFc3_BoatModeleInstanceStruct *chartInstance);
static void sf_gateway_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static void initSimStructsc3_BoatModele(SFc3_BoatModeleInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c3_attack, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_BoatModeleInstanceStruct *chartInstance,
...
static real_T c3_log(SFc3_BoatModeleInstanceStruct *chartInstance, real_T c3_x);
static void c3_eml_error(SFc3_BoatModeleInstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_BoatModeleInstanceStruct *chartInstance);
static void c3_threshold(SFc3_BoatModeleInstanceStruct *chartInstance);
static void c3_b_eml_scalar_eg(SFc3_BoatModeleInstanceStruct *chartInstance);
static real_T c3_atan2(SFc3_BoatModeleInstanceStruct *chartInstance, real_T c3_y,
  real_T c3_x);
static void c3_c_eml_scalar_eg(SFc3_BoatModeleInstanceStruct *chartInstance);
static real_T c3_mod(SFc3_BoatModeleInstanceStruct *chartInstance, real_T c3_x,
                     real_T c3_y);
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_i_emlrt_marshallIn(SFc3_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_j_emlrt_marshallIn(SFc3_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_BoatModele, const char_T
  *c3_identifier);
static uint8_T c3_k_emlrt_marshallIn(SFc3_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_log(SFc3_BoatModeleInstanceStruct *chartInstance, real_T *c3_x);
static void init_dsm_address_info(SFc3_BoatModeleInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_BoatModele = 0U;
}
  ...
  chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_BoatModele;
  ...
  *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_attack = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "attack");
  chartInstance->c3_is_active_c3_BoatModele = c3_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_BoatModele");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_BoatModele(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_BoatModele(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_BoatModeleInstanceStruct *chartInstance;
  chartInstance = (SFc3_BoatModeleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_BoatModele_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_BoatModele), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_BoatModele);
  return c3_y;
}
...
void sf_c3_BoatModele_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_BoatModele_get_autoinheritance_info(void)
{
...
mxArray *sf_c3_BoatModele_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_BoatModele_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_BoatModele(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c3_BoatModele\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_BoatModele_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_BoatModeleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c3_BoatModele(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_BoatModeleInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c3_BoatModele((SFc3_BoatModeleInstanceStruct*)
    chartInstanceVar);
  initialize_c3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_BoatModele(void *chartInstanceVar)
{
  enable_c3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_BoatModele(void *chartInstanceVar)
{
  disable_c3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_BoatModele(void *chartInstanceVar)
{
  sf_gateway_c3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_BoatModele(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_BoatModele
    ((SFc3_BoatModeleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_BoatModele();/* state var info */
...
extern void sf_internal_set_sim_state_c3_BoatModele(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_BoatModele();/* state var info */
  ...
  set_sim_state_c3_BoatModele((SFc3_BoatModeleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_BoatModele(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_BoatModele(S);
}

static void sf_opaque_set_sim_state_c3_BoatModele(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c3_BoatModele(S, st);
}

static void sf_opaque_terminate_c3_BoatModele(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_BoatModeleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_BoatModele((SFc3_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_BoatModele(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_BoatModele(SimStruct *S)
{
  SFc3_BoatModeleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_BoatModeleInstanceStruct *)utMalloc(sizeof
    (SFc3_BoatModeleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_BoatModeleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_BoatModele;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_BoatModele;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_BoatModele;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_BoatModele;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_BoatModele;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_BoatModele;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_BoatModele;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_BoatModele;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_BoatModele;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_BoatModele;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_BoatModele;
...
void c3_BoatModele_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_BoatModele(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_BoatModele(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_BoatModele(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_BoatModele_method_dispatcher.\n"
