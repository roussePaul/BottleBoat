...
static void initialize_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static void initialize_params_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static void enable_c5_BoatModele(SFc5_BoatModeleInstanceStruct *chartInstance);
static void disable_c5_BoatModele(SFc5_BoatModeleInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_BoatModele(SFc5_BoatModeleInstanceStruct *
  chartInstance);
static void set_sim_state_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_BoatModele(SFc5_BoatModeleInstanceStruct *chartInstance);
static void sf_gateway_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static void c5_chartstep_c5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static void initSimStructsc5_BoatModele(SFc5_BoatModeleInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c5_alpha, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[3]);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[9]);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_e_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
...
static const mxArray *c5_f_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_f_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
...
static void c5_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_g_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
...
static const mxArray *c5_g_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_h_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
...
static real_T c5_log(SFc5_BoatModeleInstanceStruct *chartInstance, real_T c5_x);
static void c5_eml_error(SFc5_BoatModeleInstanceStruct *chartInstance);
static void c5_eml_scalar_eg(SFc5_BoatModeleInstanceStruct *chartInstance);
static void c5_threshold(SFc5_BoatModeleInstanceStruct *chartInstance);
static void c5_b_eml_scalar_eg(SFc5_BoatModeleInstanceStruct *chartInstance);
static real_T c5_atan2(SFc5_BoatModeleInstanceStruct *chartInstance, real_T c5_y,
  real_T c5_x);
static void c5_c_eml_scalar_eg(SFc5_BoatModeleInstanceStruct *chartInstance);
static real_T c5_mpower(SFc5_BoatModeleInstanceStruct *chartInstance, real_T
  c5_a);
static void c5_b_eml_error(SFc5_BoatModeleInstanceStruct *chartInstance);
static const mxArray *c5_h_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_i_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_j_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_BoatModele, const char_T
  *c5_identifier);
static uint8_T c5_k_emlrt_marshallIn(SFc5_BoatModeleInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_log(SFc5_BoatModeleInstanceStruct *chartInstance, real_T *c5_x);
static void init_dsm_address_info(SFc5_BoatModeleInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_BoatModele = 0U;
}
  ...
  chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_BoatModele;
  ...
  *chartInstance, const mxArray *c5_st)
{
  ...
  *c5_alpha = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "alpha");
  chartInstance->c5_is_active_c5_BoatModele = c5_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_BoatModele");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_BoatModele(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_BoatModele(chartInstance);
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_BoatModeleInstanceStruct *chartInstance;
  chartInstance = (SFc5_BoatModeleInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_BoatModele_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_BoatModele), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_BoatModele);
  return c5_y;
}
...
void sf_c5_BoatModele_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_BoatModele_get_autoinheritance_info(void)
{
...
mxArray *sf_c5_BoatModele_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_BoatModele_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_BoatModele(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha\",},{M[8],M[0],T\"is_active_c5_BoatModele\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_BoatModele_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_BoatModeleInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c5_BoatModele(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_BoatModeleInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c5_BoatModele((SFc5_BoatModeleInstanceStruct*)
    chartInstanceVar);
  initialize_c5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_BoatModele(void *chartInstanceVar)
{
  enable_c5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_BoatModele(void *chartInstanceVar)
{
  disable_c5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_BoatModele(void *chartInstanceVar)
{
  sf_gateway_c5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_BoatModele(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_BoatModele
    ((SFc5_BoatModeleInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_BoatModele();/* state var info */
...
extern void sf_internal_set_sim_state_c5_BoatModele(SimStruct* S, const mxArray *
  st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_BoatModele();/* state var info */
  ...
  set_sim_state_c5_BoatModele((SFc5_BoatModeleInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_BoatModele(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_BoatModele(S);
}

static void sf_opaque_set_sim_state_c5_BoatModele(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c5_BoatModele(S, st);
}

static void sf_opaque_terminate_c5_BoatModele(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_BoatModeleInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_BoatModele((SFc5_BoatModeleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_BoatModele(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_BoatModele(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_BoatModele(SimStruct *S)
{
  SFc5_BoatModeleInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_BoatModeleInstanceStruct *)utMalloc(sizeof
    (SFc5_BoatModeleInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_BoatModeleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_BoatModele;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_BoatModele;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_BoatModele;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_BoatModele;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_BoatModele;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_BoatModele;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_BoatModele;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_BoatModele;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_BoatModele;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_BoatModele;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_BoatModele;
...
void c5_BoatModele_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_BoatModele(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_BoatModele(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_BoatModele(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_BoatModele_method_dispatcher.\n"
