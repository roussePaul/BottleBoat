...
uint32_T _BoatModeleMachineNumber_;

/* Function Declarations */

/* Function Definitions */
void BoatModele_initializer(void)
{
}

void BoatModele_terminator(void)
{
}

/* SFunction Glue Code */
unsigned int sf_BoatModele_method_dispatcher(SimStruct *simstructPtr, unsigned
  int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_BoatModele_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
...
unsigned int sf_BoatModele_process_check_sum_call( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2778659228U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3184702276U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3126554950U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3190314007U);
      ...
      switch (chartFileNumber) {
       case 1:
        {
          extern void sf_c1_BoatModele_get_check_sum(mxArray *plhs[]);
          sf_c1_BoatModele_get_check_sum(plhs);
          break;
        }

       case 2:
        {
          extern void sf_c2_BoatModele_get_check_sum(mxArray *plhs[]);
          sf_c2_BoatModele_get_check_sum(plhs);
          break;
        }
...
unsigned int sf_BoatModele_autoinheritance_info( int nlhs, mxArray * plhs[], int
...
unsigned int sf_BoatModele_get_eml_resolved_functions_info( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern const mxArray *sf_c1_BoatModele_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_BoatModele_get_eml_resolved_functions_info();
     ...
     case 2:
      {
        extern const mxArray *sf_c2_BoatModele_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c2_BoatModele_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
unsigned int sf_BoatModele_third_party_uses_info( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
unsigned int sf_BoatModele_updateBuildInfo_args_info( int nlhs, mxArray * plhs[],
  int nrhs, const mxArray * prhs[] )
{
  char commandName[64];
  char tpChksum[64];
...
void BoatModele_register_exported_symbols(SimStruct* S)
{
}

static mxArray* sRtwOptimizationInfoStruct= NULL;
mxArray* load_BoatModele_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info("BoatModele",
      "BoatModele");
...
void unload_BoatModele_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct!=NULL) {
