...
#include "c3_SailingYachtModel2.h"
...
static const char * c3_debug_family_names[37] = { "par", "V_in", "x", "y", "phi",
  ...
  "alpha_a", "u", "nargin", "nargout", "attack" };

static const char * c3_b_debug_family_names[3] = { "nargin", "nargout", "par" };

/* Function Declarations */
static void initialize_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void initialize_params_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void enable_c3_SailingYachtModel2(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
static void disable_c3_SailingYachtModel2(SFc3_SailingYachtModel2InstanceStruct *
  chartInstance);
static void c3_update_debugger_state_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void set_sim_state_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_SailingYachtModel2(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
static void sf_gateway_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void c3_chartstep_c3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void initSimStructsc3_SailingYachtModel2
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_attack, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[3]);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[9]);
...
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[16]);
...
static const mxArray *c3_f_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_f_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[4]);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_g_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[11]);
...
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_h_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  c3_srLgvkCzuuZn3rWrmrpDanB *c3_y);
static void c3_g_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(const mxArray **c3_info);
static const mxArray *c3_emlrt_marshallOut(const char * c3_u);
static const mxArray *c3_b_emlrt_marshallOut(const uint32_T c3_u);
static real_T c3_log(SFc3_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T c3_x);
static void c3_eml_error(SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
static void c3_threshold(SFc3_SailingYachtModel2InstanceStruct *chartInstance);
static void c3_b_eml_scalar_eg(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
static real_T c3_atan2(SFc3_SailingYachtModel2InstanceStruct *chartInstance,
  real_T c3_y, real_T c3_x);
static void c3_c_eml_scalar_eg(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
static real_T c3_mod(SFc3_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T c3_x, real_T c3_y);
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_i_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_j_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_SailingYachtModel2, const
  char_T *c3_identifier);
static uint8_T c3_k_emlrt_marshallIn(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_log(SFc3_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T *c3_x);
static void init_dsm_address_info(SFc3_SailingYachtModel2InstanceStruct
  *chartInstance);
  ...
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SailingYachtModel2 = 0U;
}
  ...
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  real_T *c3_attack;
  c3_attack = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_st = NULL;
  c3_st = NULL;
  c3_y = NULL;
  sf_mex_assign(&c3_y, sf_mex_createcellmatrix(2, 1), false);
  c3_hoistedGlobal = *c3_attack;
  c3_u = c3_hoistedGlobal;
  c3_b_y = NULL;
  sf_mex_assign(&c3_b_y, sf_mex_create("y", &c3_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c3_y, 0, c3_b_y);
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_SailingYachtModel2;
  ...
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_attack = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "attack");
  chartInstance->c3_is_active_c3_SailingYachtModel2 = c3_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_SailingYachtModel2");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_SailingYachtModel2(chartInstance);
  ...
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_SailingYachtModel2(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SailingYachtModel2MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c3_attack, 1U);
}
  ...
  (SFc3_SailingYachtModel2InstanceStruct *chartInstance)
{
  int32_T c3_i1;
  real_T c3_u[11];
  uint32_T c3_debug_family_var_map[37];
  c3_srLgvkCzuuZn3rWrmrpDanB c3_par;
  real_T c3_V_in[11];
  real_T c3_x;
  real_T c3_y;
  real_T c3_phi;
  ...
  real_T c3_attack;
  static c3_srLgvkCzuuZn3rWrmrpDanB c3_r0 = { 25900.0, 133690.0, 24760.0, 2180.0,
  ...
  int32_T c3_i9;
  int32_T c3_i10;
  static real_T c3_b[3] = { -10.0, 1.2246467991473533E-15, 0.0 };
  ...
  real_T *c3_b_attack;
  real_T (*c3_c_u)[11];
  c3_b_attack = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_c_u = (real_T (*)[11])ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  for (c3_i1 = 0; c3_i1 < 11; c3_i1++) {
    c3_u[c3_i1] = (*c3_c_u)[c3_i1];
  }

  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 37U, 39U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_par, 0U, c3_g_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_V_in, MAX_uint32_T,
    c3_b_sf_marshallOut, c3_f_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_y, 3U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_phi, 4U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_psi, 5U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v, 6U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_p, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_r, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_nu, 9U, c3_f_sf_marshallOut,
    c3_e_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_delta_r, 10U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_delta_sbar, 11U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_y_w, 12U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_M_RB, 13U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_C_RB, 14U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_M_A, 15U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_C_A, 16U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_M, 17U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_v_t, 18U, c3_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_v_tw, 19U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_R1, 20U, c3_d_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_R2, 21U, c3_d_sf_marshallOut,
    c3_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_v_tb, 22U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_V_awb, 23U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_V_awu, 24U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_V_awv, 25U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_aw, 26U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_delta_s, 27U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_as, 28U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v_aru, 29U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v_arv, 30U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_ar, 31U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_a, 32U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_b_u, MAX_uint32_T, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_b_V_in, MAX_uint32_T,
    c3_c_sf_marshallOut, c3_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargin, 34U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 35U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_u, 33U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_attack, 36U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_M_RB[2] = 0.0;
  c3_M_RB[6] = 0.0;
  c3_M_RB[10] = c3_par.Ixx;
  c3_M_RB[14] = -c3_par.Ixz;
  c3_M_RB[3] = 0.0;
  c3_M_RB[7] = 0.0;
  c3_M_RB[11] = -c3_par.Ixz;
  c3_M_RB[15] = c3_par.Izz;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 41);
  c3_C_RB[0] = 0.0;
  c3_C_RB[4] = -25900.0 * c3_r;
  c3_C_RB[8] = 0.0;
  c3_C_RB[12] = 0.0;
  c3_C_RB[1] = 25900.0 * c3_r;
  c3_C_RB[5] = 0.0;
  c3_C_RB[9] = 0.0;
  c3_C_RB[13] = 0.0;
  c3_i3 = 0;
  ...
  c3_M_A[5] = c3_par.a22;
  c3_M_A[9] = c3_par.a24;
  c3_M_A[13] = c3_par.a26;
  c3_M_A[2] = 0.0;
  c3_M_A[6] = c3_par.a24;
  c3_M_A[10] = c3_par.a44;
  c3_M_A[14] = c3_par.a46;
  c3_M_A[3] = 0.0;
  c3_M_A[7] = c3_par.a26;
  c3_M_A[11] = c3_par.a46;
  c3_M_A[15] = c3_par.a66;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 44);
  c3_C_A[0] = 0.0;
  c3_C_A[4] = 0.0;
  c3_C_A[8] = 0.0;
  c3_C_A[12] = (-17430.0 * c3_nu[1] - -13160.0 * c3_nu[2]) - -6190.0 * c3_nu[3];
  c3_C_A[1] = 0.0;
  c3_C_A[5] = 0.0;
  c3_C_A[9] = 0.0;
  c3_C_A[13] = 970.0 * c3_nu[0];
  c3_i7 = 0;
  ...
  c3_e_x = c3_d_x;
  c3_f_x = c3_e_x;
  c3_b_y = c3_f_x / 0.0005;
  c3_b_A = c3_b_y;
  c3_b_log(chartInstance, &c3_b_A);
  c3_g_x = c3_b_A;
  c3_h_x = c3_g_x;
  c3_i_x = c3_h_x;
  c3_c_y = c3_i_x / 10.050181931686932;
  c3_a = c3_c_y;
  for (c3_i11 = 0; c3_i11 < 3; c3_i11++) {
    c3_v_tw[c3_i11] = c3_a * c3_b[c3_i11];
  }
  ...
  c3_t_x = -c3_phi;
  c3_u_x = c3_t_x;
  c3_u_x = muDoubleScalarSin(c3_u_x);
  c3_v_x = -c3_phi;
  c3_w_x = c3_v_x;
  ...
  for (c3_i16 = 0; c3_i16 < 9; c3_i16++) {
    c3_b_a[c3_i16] = c3_R2[c3_i16];
  }

  for (c3_i17 = 0; c3_i17 < 9; c3_i17++) {
    c3_b_b[c3_i17] = c3_R1[c3_i17];
  }
  ...
  for (c3_i18 = 0; c3_i18 < 3; c3_i18++) {
    ...
    for (c3_i20 = 0; c3_i20 < 3; c3_i20++) {
      c3_d_y[c3_i19 + c3_i18] = 0.0;
      c3_i21 = 0;
      for (c3_i22 = 0; c3_i22 < 3; c3_i22++) {
        c3_d_y[c3_i19 + c3_i18] += c3_b_a[c3_i21 + c3_i18] * c3_b_b[c3_i22 +
          c3_i19];
        c3_i21 += 3;
      }
  ...
  for (c3_i26 = 0; c3_i26 < 3; c3_i26++) {
    c3_C[c3_i26] = c3_v_tb[c3_i26];
  }

  for (c3_i27 = 0; c3_i27 < 3; c3_i27++) {
    c3_v_tb[c3_i27] = c3_C[c3_i27];
  }

  c3_threshold(chartInstance);
  for (c3_i28 = 0; c3_i28 < 3; c3_i28++) {
    c3_C[c3_i28] = c3_v_tb[c3_i28];
  }

  for (c3_i29 = 0; c3_i29 < 3; c3_i29++) {
    c3_v_tb[c3_i29] = c3_C[c3_i29];
  }
  ...
  for (c3_i30 = 0; c3_i30 < 3; c3_i30++) {
    ...
    for (c3_i32 = 0; c3_i32 < 3; c3_i32++) {
      c3_v_tb[c3_i30] += c3_d_y[c3_i31 + c3_i30] * c3_c_b[c3_i32];
      c3_i31 += 3;
    }
  }
  ...
  c3_b_V_in[1] = c3_v;
  c3_b_V_in[2] = 0.0;
  _SFD_SYMBOL_SWITCH(1U, 34U);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 56);
  c3_c_b[0] = c3_p;
  c3_c_b[1] = 0.0;
  c3_c_b[2] = c3_r;
  c3_c1 = c3_c_b[1] * -11.58 - c3_c_b[2] * 0.0;
  c3_c2 = c3_c_b[2] * 0.0 - c3_c_b[0] * -11.58;
  c3_c3 = c3_c_b[0] * 0.0 - c3_c_b[1] * 0.0;
  c3_c_b[0] = c3_c1;
  c3_c_b[1] = c3_c2;
  c3_c_b[2] = c3_c3;
  for (c3_i33 = 0; c3_i33 < 3; c3_i33++) {
    c3_V_awb[c3_i33] = (c3_v_tb[c3_i33] - c3_b_V_in[c3_i33]) - c3_c_b[c3_i33];
  }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_attack, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_attack), &c3_thisId);
  sf_mex_destroy(&c3_attack);
  return c3_y;
}
...
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  const mxArray *c3_attack;
  const char_T *c3_identifier;
  emlrtMsgIdentifier c3_thisId;
  real_T c3_y;
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_attack = sf_mex_dup(c3_mxArrayInData);
  ...
  *c3_inData)
{
  ...
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  for (c3_i34 = 0; c3_i34 < 11; c3_i34++) {
    c3_b_inData[c3_i34] = (*(real_T (*)[11])c3_inData)[c3_i34];
  }

  for (c3_i35 = 0; c3_i35 < 11; c3_i35++) {
  ...
  *c3_inData)
{
  ...
  for (c3_i36 = 0; c3_i36 < 3; c3_i36++) {
    c3_b_inData[c3_i36] = (*(real_T (*)[3])c3_inData)[c3_i36];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_V_in = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_V_in), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_V_in);
  for (c3_i39 = 0; c3_i39 < 3; c3_i39++) {
    (*(real_T (*)[3])c3_outData)[c3_i39] = c3_y[c3_i39];
  }
  ...
  *c3_inData)
{
  ...
  for (c3_i41 = 0; c3_i41 < 3; c3_i41++) {
    for (c3_i42 = 0; c3_i42 < 3; c3_i42++) {
      c3_b_inData[c3_i42 + c3_i40] = (*(real_T (*)[9])c3_inData)[c3_i42 + c3_i40];
    }
  ...
  for (c3_i44 = 0; c3_i44 < 3; c3_i44++) {
    for (c3_i45 = 0; c3_i45 < 3; c3_i45++) {
      c3_u[c3_i45 + c3_i43] = c3_b_inData[c3_i45 + c3_i43];
    }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_R2 = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_R2), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_R2);
  c3_i47 = 0;
  for (c3_i48 = 0; c3_i48 < 3; c3_i48++) {
    for (c3_i49 = 0; c3_i49 < 3; c3_i49++) {
      (*(real_T (*)[9])c3_outData)[c3_i49 + c3_i47] = c3_y[c3_i49 + c3_i47];
    }
  ...
  *c3_inData)
{
  ...
  for (c3_i51 = 0; c3_i51 < 4; c3_i51++) {
    for (c3_i52 = 0; c3_i52 < 4; c3_i52++) {
      c3_b_inData[c3_i52 + c3_i50] = (*(real_T (*)[16])c3_inData)[c3_i52 +
        c3_i50];
    }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_M), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_M);
  c3_i57 = 0;
  for (c3_i58 = 0; c3_i58 < 4; c3_i58++) {
    for (c3_i59 = 0; c3_i59 < 4; c3_i59++) {
      (*(real_T (*)[16])c3_outData)[c3_i59 + c3_i57] = c3_y[c3_i59 + c3_i57];
    }
  ...
  *c3_inData)
{
  ...
  for (c3_i60 = 0; c3_i60 < 4; c3_i60++) {
    c3_b_inData[c3_i60] = (*(real_T (*)[4])c3_inData)[c3_i60];
  }
  ...
  real_T c3_y[4])
{
  ...
  int32_T c3_i62;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv5, 1, 0, 0U, 1, 0U, 1, 4);
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_nu = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_nu), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_nu);
  for (c3_i63 = 0; c3_i63 < 4; c3_i63++) {
    (*(real_T (*)[4])c3_outData)[c3_i63] = c3_y[c3_i63];
  }
  ...
  real_T c3_y[11])
{
  ...
  int32_T c3_i64;
  (void)chartInstance;
  sf_mex_import(c3_parentId, sf_mex_dup(c3_u), c3_dv6, 1, 0, 0U, 1, 0U, 1, 11);
  for (c3_i64 = 0; c3_i64 < 11; c3_i64++) {
    c3_y[c3_i64] = c3_dv6[c3_i64];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_V_in), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_V_in);
  for (c3_i65 = 0; c3_i65 < 11; c3_i65++) {
    (*(real_T (*)[11])c3_outData)[c3_i65] = c3_y[c3_i65];
  }
...
{
  const mxArray *c3_mxArrayOutData = NULL;
  c3_srLgvkCzuuZn3rWrmrpDanB c3_u;
  const mxArray *c3_y = NULL;
  real_T c3_b_u;
  const mxArray *c3_b_y = NULL;
  real_T c3_c_u;
  ...
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
  c3_mxArrayOutData = NULL;
  c3_u = *(c3_srLgvkCzuuZn3rWrmrpDanB *)c3_inData;
  c3_y = NULL;
...
{
  emlrtMsgIdentifier c3_thisId;
  static const char * c3_fieldNames[52] = { "m", "Ixx", "Izz", "Ixz", "a11",
  ...
  sf_mex_check_struct(c3_parentId, c3_u, 52, c3_fieldNames, 0U, NULL);
  c3_thisId.fIdentifier = "m";
  c3_y->m = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c3_u,
    "m", "m", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Ixx";
  c3_y->Ixx = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Ixx", "Ixx", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Izz";
  c3_y->Izz = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Izz", "Izz", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Ixz";
  c3_y->Ixz = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Ixz", "Ixz", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a11";
  c3_y->a11 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a11", "a11", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a22";
  c3_y->a22 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a22", "a22", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a44";
  c3_y->a44 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a44", "a44", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a66";
  c3_y->a66 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a66", "a66", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a24";
  c3_y->a24 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a24", "a24", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a26";
  c3_y->a26 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a26", "a26", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a46";
  c3_y->a46 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "a46", "a46", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "vt";
  c3_y->vt = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "vt", "vt", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "alpha_w";
  c3_y->alpha_w = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c3_u, "alpha_w", "alpha_w", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "rho_a";
  c3_y->rho_a = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "rho_a", "rho_a", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "As";
  c3_y->As = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "As", "As", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "h0";
  c3_y->h0 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "h0", "h0", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "h1";
  c3_y->h1 = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "h1", "h1", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "z_s";
  c3_y->z_s = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "z_s", "z_s", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "xs";
  c3_y->xs = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "xs", "xs", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "ys";
  c3_y->ys = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "ys", "ys", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zs";
  c3_y->zs = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "zs", "zs", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Xce";
  c3_y->Xce = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Xce", "Xce", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Xm";
  c3_y->Xm = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Xm", "Xm", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "rho_w";
  c3_y->rho_w = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "rho_w", "rho_w", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Ar";
  c3_y->Ar = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Ar", "Ar", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "d_r";
  c3_y->d_r = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "d_r", "d_r", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zeta_r";
  c3_y->zeta_r = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c3_u, "zeta_r", "zeta_r", 0)),
    &c3_thisId);
  c3_thisId.fIdentifier = "x_r";
  c3_y->x_r = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "x_r", "x_r", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "z_r";
  c3_y->z_r = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "z_r", "z_r", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "xr";
  c3_y->xr = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "xr", "xr", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "yr";
  c3_y->yr = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "yr", "yr", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zr";
  c3_y->zr = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "zr", "zr", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "Ak";
  c3_y->Ak = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "Ak", "Ak", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "d_k";
  c3_y->d_k = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "d_k", "d_k", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zeta_k";
  c3_y->zeta_k = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c3_u, "zeta_k", "zeta_k", 0)),
    &c3_thisId);
  c3_thisId.fIdentifier = "x_k";
  c3_y->x_k = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "x_k", "x_k", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "z_k";
  c3_y->z_k = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "z_k", "z_k", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "xk";
  c3_y->xk = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "xk", "xk", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "yk";
  c3_y->yk = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "yk", "yk", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zk";
  c3_y->zk = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "zk", "zk", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "x_h";
  c3_y->x_h = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "x_h", "x_h", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "z_h";
  c3_y->z_h = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "z_h", "z_h", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "xh";
  c3_y->xh = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "xh", "xh", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "yh";
  c3_y->yh = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "yh", "yh", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "zh";
  c3_y->zh = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "zh", "zh", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "w_c";
  c3_y->w_c = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "w_c", "w_c", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "x_c";
  c3_y->x_c = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "x_c", "x_c", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "y_bm";
  c3_y->y_bm = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c3_u, "y_bm", "y_bm", 0)), &c3_thisId);
  c3_thisId.fIdentifier = "a";
  c3_y->a = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c3_u,
    "a", "a", 0)), &c3_thisId);
  ...
  c3_y->d = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c3_u,
    "d", "d", 0)), &c3_thisId);
  sf_mex_destroy(&c3_u);
}
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_par), &c3_thisId, &c3_y);
  sf_mex_destroy(&c3_par);
  *(c3_srLgvkCzuuZn3rWrmrpDanB *)c3_outData = c3_y;
  sf_mex_destroy(&c3_mxArrayInData);
}

const mxArray *sf_c3_SailingYachtModel2_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("modeleBoat"), "name", "name",
                  0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[E]/home/paul/KTH/Optimal Control/BottleBoat/Simulink/modeleBoat.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1430582785U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 8);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 13);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 13);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("log"), "name", "name", 15);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 15);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1286818728U), "fileTimeLo",
                  "fileTimeLo", 17);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 17);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 18);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("realmax"), "name", "name", 18);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 18);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mrdivide"), "name", "name", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 21);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("cross"), "name", "name", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs35), "lhs", "lhs",
                  35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("atan2"), "name", "name", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mod"), "name", "name", 41);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(1307651238U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c3_info, c3_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eps"), "name", "name", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 49);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_eps"), "name", "name", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
                     ...
                     real_T c3_x, real_T c3_y)
{
  ...
  if (c3_b_y == 0.0) {
    ...
    if (c3_b_y == c3_d_x) {
      ...
      if (c3_c_y <= 2.2204460492503131E-16 * c3_d_y) {
        c3_r = 0.0;
      } else {
        c3_k_x = c3_r;
        c3_l_x = c3_k_x;
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_SailingYachtModel2), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_SailingYachtModel2);
  return c3_y;
}
...
void sf_c3_SailingYachtModel2_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3172440186U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3995265913U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3522305665U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3917550021U);
}

mxArray *sf_c3_SailingYachtModel2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("jmD4X94ZIV3FGAklKqAANH");
...
mxArray *sf_c3_SailingYachtModel2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SailingYachtModel2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SailingYachtModel2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c3_SailingYachtModel2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_SailingYachtModel2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,4,9,0,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",618,-1,2740);
        _SFD_CV_INIT_EML_FCN(0,1,"ruddercoef",2740,-1,4167);
        _SFD_CV_INIT_EML_FCN(0,2,"keelcoef",4167,-1,5601);
        _SFD_CV_INIT_EML_FCN(0,3,"resistancehull",5601,-1,5899);
        _SFD_CV_INIT_EML_IF(0,1,0,2055,2077,2104,2191);
        _SFD_CV_INIT_EML_IF(0,1,1,2104,2131,2159,2191);
        _SFD_CV_INIT_EML_IF(0,1,2,2431,2445,2485,2565);
        _SFD_CV_INIT_EML_IF(0,1,3,2494,2509,-1,2561);
        _SFD_CV_INIT_EML_IF(0,1,4,3773,3787,3827,3907);
        _SFD_CV_INIT_EML_IF(0,1,5,3836,3851,-1,3903);
        _SFD_CV_INIT_EML_IF(0,1,6,5207,5221,5261,5341);
        _SFD_CV_INIT_EML_IF(0,1,7,5270,5285,-1,5337);
        _SFD_CV_INIT_EML_IF(0,1,8,5774,5789,5836,5899);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c3_attack);
        }
      }
    } else {
...
{
  return "8hJanoFkAUq13QqujzrzCE";
}

static void sf_opaque_initialize_c3_SailingYachtModel2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
  initialize_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_SailingYachtModel2(void *chartInstanceVar)
{
  enable_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_SailingYachtModel2(void *chartInstanceVar)
{
  disable_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_SailingYachtModel2(void *chartInstanceVar)
{
  sf_gateway_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SailingYachtModel2(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SailingYachtModel2
    ((SFc3_SailingYachtModel2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SailingYachtModel2();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SailingYachtModel2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SailingYachtModel2();/* state var info */
  ...
  set_sim_state_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SailingYachtModel2(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SailingYachtModel2(S);
}

static void sf_opaque_set_sim_state_c3_SailingYachtModel2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_SailingYachtModel2(S, st);
}

static void sf_opaque_terminate_c3_SailingYachtModel2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SailingYachtModel2InstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_SailingYachtModel2((SFc3_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SailingYachtModel2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_SailingYachtModel2
      ((SFc3_SailingYachtModel2InstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_SailingYachtModel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3656723725U));
  ssSetChecksum1(S,(3819020U));
  ssSetChecksum2(S,(3638807622U));
  ssSetChecksum3(S,(3193495721U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_SailingYachtModel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SailingYachtModel2(SimStruct *S)
{
  SFc3_SailingYachtModel2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SailingYachtModel2InstanceStruct *)utMalloc(sizeof
    (SFc3_SailingYachtModel2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SailingYachtModel2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_SailingYachtModel2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_SailingYachtModel2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_SailingYachtModel2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SailingYachtModel2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_SailingYachtModel2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_SailingYachtModel2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_SailingYachtModel2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_SailingYachtModel2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SailingYachtModel2;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SailingYachtModel2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_SailingYachtModel2;
...
void c3_SailingYachtModel2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SailingYachtModel2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SailingYachtModel2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SailingYachtModel2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SailingYachtModel2_method_dispatcher.\n"
