...
#include "c1_SailingYachtModel2.h"
...
static void initialize_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void initialize_params_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void enable_c1_SailingYachtModel2(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
static void disable_c1_SailingYachtModel2(SFc1_SailingYachtModel2InstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void set_sim_state_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_SailingYachtModel2(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
static void sf_gateway_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void c1_chartstep_c1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void initSimStructsc1_SailingYachtModel2
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_attack, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[3]);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[9]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[16]);
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_f_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[4]);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_g_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[11]);
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
...
static real_T c1_log(SFc1_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T c1_x);
static void c1_eml_error(SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
static void c1_threshold(SFc1_SailingYachtModel2InstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
static void c1_c_eml_scalar_eg(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
static real_T c1_mod(SFc1_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T c1_x, real_T c1_y);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_i_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_j_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_SailingYachtModel2, const
  char_T *c1_identifier);
static uint8_T c1_k_emlrt_marshallIn(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_log(SFc1_SailingYachtModel2InstanceStruct *chartInstance,
                     real_T *c1_x);
static void init_dsm_address_info(SFc1_SailingYachtModel2InstanceStruct
  *chartInstance);
  ...
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_SailingYachtModel2 = 0U;
}
  ...
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_SailingYachtModel2;
  ...
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_attack = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "attack");
  chartInstance->c1_is_active_c1_SailingYachtModel2 = c1_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_SailingYachtModel2");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_SailingYachtModel2(chartInstance);
  ...
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_SailingYachtModel2(chartInstance);
  ...
  (SFc1_SailingYachtModel2InstanceStruct *chartInstance)
{
  ...
  int32_T c1_i9;
  int32_T c1_i10;
  static real_T c1_b[3] = { -10.0, 1.2246467991473533E-15, 0.0 };
  ...
  c1_C_A[4] = 0.0;
  c1_C_A[8] = 0.0;
  c1_C_A[12] = (-17430.0 * c1_nu[1] - -13160.0 * c1_nu[2]) - -6190.0 * c1_nu[3];
  c1_C_A[1] = 0.0;
  c1_C_A[5] = 0.0;
  c1_C_A[9] = 0.0;
  c1_C_A[13] = 970.0 * c1_nu[0];
  c1_i7 = 0;
  ...
  c1_C_A[3] = (17430.0 * c1_nu[1] + -13160.0 * c1_nu[2]) + -6190.0 * c1_nu[3];
  ...
  c1_e_x = c1_d_x;
  c1_f_x = c1_e_x;
  c1_b_y = c1_f_x / 0.0005;
  c1_b_A = c1_b_y;
  c1_b_log(chartInstance, &c1_b_A);
  c1_g_x = c1_b_A;
  c1_h_x = c1_g_x;
  c1_i_x = c1_h_x;
  c1_c_y = c1_i_x / 10.050181931686932;
  c1_a = c1_c_y;
  ...
  for (c1_i18 = 0; c1_i18 < 3; c1_i18++) {
    ...
    for (c1_i20 = 0; c1_i20 < 3; c1_i20++) {
      c1_d_y[c1_i19 + c1_i18] = 0.0;
      c1_i21 = 0;
      for (c1_i22 = 0; c1_i22 < 3; c1_i22++) {
        c1_d_y[c1_i19 + c1_i18] += c1_b_a[c1_i21 + c1_i18] * c1_b_b[c1_i22 +
          c1_i19];
        c1_i21 += 3;
      }
  ...
  for (c1_i30 = 0; c1_i30 < 3; c1_i30++) {
    ...
    for (c1_i32 = 0; c1_i32 < 3; c1_i32++) {
      c1_v_tb[c1_i30] += c1_d_y[c1_i31 + c1_i30] * c1_c_b[c1_i32];
      c1_i31 += 3;
    }
  }
  ...
  c1_c_b[1] = 0.0;
  c1_c_b[2] = c1_r;
  c1_c1 = c1_c_b[1] * -11.58 - c1_c_b[2] * 0.0;
  c1_c2 = c1_c_b[2] * 0.0 - c1_c_b[0] * -11.58;
  c1_c3 = c1_c_b[0] * 0.0 - c1_c_b[1] * 0.0;
  c1_c_b[0] = c1_c1;
  c1_c_b[1] = c1_c2;
  c1_c_b[2] = c1_c3;
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_SailingYachtModel2InstanceStruct *chartInstance;
  chartInstance = (SFc1_SailingYachtModel2InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_SailingYachtModel2_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_SailingYachtModel2), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_SailingYachtModel2);
  return c1_y;
}
...
void sf_c1_SailingYachtModel2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_SailingYachtModel2_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_SailingYachtModel2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_SailingYachtModel2_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_SailingYachtModel2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c1_SailingYachtModel2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_SailingYachtModel2_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_SailingYachtModel2InstanceStruct *)
...
static void sf_opaque_initialize_c1_SailingYachtModel2(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
  initialize_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_SailingYachtModel2(void *chartInstanceVar)
{
  enable_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_SailingYachtModel2(void *chartInstanceVar)
{
  disable_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_SailingYachtModel2(void *chartInstanceVar)
{
  sf_gateway_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_SailingYachtModel2(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_SailingYachtModel2
    ((SFc1_SailingYachtModel2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_SailingYachtModel2();/* state var info */
...
extern void sf_internal_set_sim_state_c1_SailingYachtModel2(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_SailingYachtModel2();/* state var info */
  ...
  set_sim_state_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_SailingYachtModel2(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_SailingYachtModel2(S);
}

static void sf_opaque_set_sim_state_c1_SailingYachtModel2(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_SailingYachtModel2(S, st);
}

static void sf_opaque_terminate_c1_SailingYachtModel2(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_SailingYachtModel2InstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_SailingYachtModel2((SFc1_SailingYachtModel2InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_SailingYachtModel2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_SailingYachtModel2
      ((SFc1_SailingYachtModel2InstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_SailingYachtModel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_SailingYachtModel2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_SailingYachtModel2(SimStruct *S)
{
  SFc1_SailingYachtModel2InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_SailingYachtModel2InstanceStruct *)utMalloc(sizeof
    (SFc1_SailingYachtModel2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_SailingYachtModel2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_SailingYachtModel2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_SailingYachtModel2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_SailingYachtModel2;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_SailingYachtModel2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_SailingYachtModel2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_SailingYachtModel2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_SailingYachtModel2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_SailingYachtModel2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_SailingYachtModel2;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_SailingYachtModel2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_SailingYachtModel2;
...
void c1_SailingYachtModel2_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_SailingYachtModel2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_SailingYachtModel2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_SailingYachtModel2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_SailingYachtModel2_method_dispatcher.\n"
