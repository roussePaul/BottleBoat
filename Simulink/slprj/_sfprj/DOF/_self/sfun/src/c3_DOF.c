...
static const char * c3_debug_family_names[34] = { "par", "V_in", "x", "y", "phi",
  "psi", "v", "p", "r", "nu", "delta_r", "delta_sbar", "y_w", "M_RB", "C_RB",
  "M_A", "C_A", "M", "v_t", "v_tw", "R1", "R2", "v_tb", "V_awb", "V_awu",
  "V_awv", "v_aru", "v_arv", "alpha_ar", "alpha_a", "u", "nargin", "nargout",
  "attack" };

/* Function Declarations */
static void initialize_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void initialize_params_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void enable_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void disable_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_DOF(SFc3_DOFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void set_sim_state_c3_DOF(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_st);
static void finalize_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void sf_gateway_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void c3_chartstep_c3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void initSimStructsc3_DOF(SFc3_DOFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_attack, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[3]);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[9]);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[16]);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_f_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_f_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[4]);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_g_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, real_T c3_y[11]);
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_h_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance, const
  mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
...
static real_T c3_abs(SFc3_DOFInstanceStruct *chartInstance, real_T c3_x);
static real_T c3_log(SFc3_DOFInstanceStruct *chartInstance, real_T c3_x);
static void c3_eml_error(SFc3_DOFInstanceStruct *chartInstance);
static void c3_eml_scalar_eg(SFc3_DOFInstanceStruct *chartInstance);
static void c3_threshold(SFc3_DOFInstanceStruct *chartInstance);
static void c3_b_eml_scalar_eg(SFc3_DOFInstanceStruct *chartInstance);
static real_T c3_atan2(SFc3_DOFInstanceStruct *chartInstance, real_T c3_y,
  real_T c3_x);
static void c3_c_eml_scalar_eg(SFc3_DOFInstanceStruct *chartInstance);
static real_T c3_mod(SFc3_DOFInstanceStruct *chartInstance, real_T c3_x, real_T
                     c3_y);
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_i_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_j_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance,
  const mxArray *c3_b_is_active_c3_DOF, const char_T *c3_identifier);
static uint8_T c3_k_emlrt_marshallIn(SFc3_DOFInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_log(SFc3_DOFInstanceStruct *chartInstance, real_T *c3_x);
static void init_dsm_address_info(SFc3_DOFInstanceStruct *chartInstance);
...
static void initialize_c3_DOF(SFc3_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_DOF = 0U;
}
...
static const mxArray *get_sim_state_c3_DOF(SFc3_DOFInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_DOF;
  ...
  mxArray *c3_st)
{
  ...
  *c3_attack = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "attack");
  chartInstance->c3_is_active_c3_DOF = c3_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 1)), "is_active_c3_DOF");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_DOF(chartInstance);
...
static void sf_gateway_c3_DOF(SFc3_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_DOF(chartInstance);
...
static void c3_chartstep_c3_DOF(SFc3_DOFInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 34U, 36U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_par, 0U, c3_g_sf_marshallOut,
    c3_g_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_M, 17U, c3_e_sf_marshallOut,
    c3_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_v_t, 18U, c3_c_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_V_awv, 25U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v_aru, 26U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v_arv, 27U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_ar, 28U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_alpha_a, 29U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargin, 31U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 32U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(c3_u, 30U, c3_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_attack, 33U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c3_par.alpha_w = 3.1415926535897931;
  ...
  c3_C_RB[0] = 0.0;
  c3_C_RB[4] = -c3_par.m * c3_r;
  c3_C_RB[8] = 0.0;
  c3_C_RB[12] = 0.0;
  c3_C_RB[1] = c3_par.m * c3_r;
  c3_C_RB[5] = 0.0;
  c3_C_RB[9] = 0.0;
  c3_C_RB[13] = 0.0;
  c3_i3 = 0;
  ...
  c3_C_A[4] = 0.0;
  c3_C_A[8] = 0.0;
  c3_C_A[12] = (-c3_par.a22 * c3_nu[1] - c3_par.a24 * c3_nu[2]) - c3_par.a26 *
    c3_nu[3];
  c3_C_A[1] = 0.0;
  c3_C_A[5] = 0.0;
  c3_C_A[9] = 0.0;
  c3_C_A[13] = c3_par.a11 * c3_nu[0];
  c3_i7 = 0;
  ...
  c3_C_A[3] = (c3_par.a22 * c3_nu[1] + c3_par.a24 * c3_nu[2]) + c3_par.a26 *
    c3_nu[3];
  c3_C_A[7] = -c3_par.a11 * c3_nu[0];
  c3_C_A[11] = 0.0;
  c3_C_A[15] = 0.0;
  ...
  c3_m_x = c3_l_x;
  c3_h_y = c3_g_y;
  c3_i_y = c3_m_x / c3_h_y;
  c3_c_A = c3_e_y;
  c3_b_log(chartInstance, &c3_c_A);
  c3_c_B = c3_i_y;
  c3_b_log(chartInstance, &c3_c_B);
  c3_n_x = c3_c_A;
  c3_j_y = c3_c_B;
  c3_o_x = c3_n_x;
  c3_k_y = c3_j_y;
  c3_p_x = c3_o_x;
  c3_l_y = c3_k_y;
  c3_m_y = c3_p_x / c3_l_y;
  c3_a = c3_m_y;
  for (c3_i10 = 0; c3_i10 < 3; c3_i10++) {
    c3_b[c3_i10] = c3_v_t[c3_i10];
  }
  ...
  for (c3_i18 = 0; c3_i18 < 3; c3_i18++) {
    ...
    for (c3_i20 = 0; c3_i20 < 3; c3_i20++) {
      c3_n_y[c3_i19 + c3_i18] = 0.0;
      c3_i21 = 0;
      for (c3_i22 = 0; c3_i22 < 3; c3_i22++) {
        c3_n_y[c3_i19 + c3_i18] += c3_b_a[c3_i21 + c3_i18] * c3_b_b[c3_i22 +
          c3_i19];
        c3_i21 += 3;
      }
  ...
  for (c3_i30 = 0; c3_i30 < 3; c3_i30++) {
    ...
    for (c3_i32 = 0; c3_i32 < 3; c3_i32++) {
      c3_v_tb[c3_i30] += c3_n_y[c3_i31 + c3_i30] * c3_b[c3_i32];
      c3_i31 += 3;
    }
  }
  ...
  c3_b[1] = c3_par.ys;
  c3_b[2] = c3_par.zs;
  c3_c1 = c3_C[1] * c3_b[2] - c3_C[2] * c3_b[1];
  c3_c2 = c3_C[2] * c3_b[0] - c3_C[0] * c3_b[2];
  c3_c3 = c3_C[0] * c3_b[1] - c3_C[1] * c3_b[0];
  c3_C[0] = c3_c1;
  c3_C[1] = c3_c2;
  c3_C[2] = c3_c3;
  for (c3_i33 = 0; c3_i33 < 3; c3_i33++) {
    c3_V_awb[c3_i33] = (c3_v_tb[c3_i33] - c3_b_V_in[c3_i33]) - c3_C[c3_i33];
  }
  ...
  c3_v_aru = -c3_b_u + c3_r * c3_par.yr;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 121);
  c3_v_arv = (-c3_v - c3_r * c3_par.xr) + c3_p * c3_par.zr;
  ...
  if (CV_EML_IF(0, 1, 0, c3_attack > 3.1415926535897931)) {
    ...
    if (CV_EML_IF(0, 1, 1, c3_attack < -3.1415926535897931)) {
  ...
  c3_ib_x = c3_hb_x;
  c3_jb_x = c3_ib_x;
  c3_o_y = c3_jb_x / 3.1415926535897931;
  c3_attack = c3_o_y * 180.0;
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, -137);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_DOFInstanceStruct *chartInstance;
  chartInstance = (SFc3_DOFInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_DOF_get_eml_resolved_functions_info(void)
{
  const mxArray *c3_nameCaptureInfo = NULL;
  c3_nameCaptureInfo = NULL;
  sf_mex_assign(&c3_nameCaptureInfo, sf_mex_createstruct("structure", 2, 52, 1),
                false);
...
static void c3_info_helper(const mxArray **c3_info)
{
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("abs"), "name", "name", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 9);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("rdivide"), "name", "name", 9);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_div"), "name", "name", 12);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("log"), "name", "name", 14);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 17);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("realmax"), "name", "name", 17);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs33), "lhs", "lhs",
                  33);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("cross"), "name", "name", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("atan2"), "name", "name", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, sf_mex_duplicatearraysafe(&c3_lhs39), "lhs", "lhs",
                  39);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(""), "context", "context", 40);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("mod"), "name", "name", 40);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eps"), "name", "name", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("eml_eps"), "name", "name", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c3_info, c3_emlrt_marshallOut(
  ...
  const mxArray *c3_b_is_active_c3_DOF, const char_T *c3_identifier)
{
  ...
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_y = c3_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_b_is_active_c3_DOF),
    &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_DOF);
  return c3_y;
}
...
void sf_c3_DOF_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3688583889U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1658526840U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2271870289U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(479829139U);
}

mxArray *sf_c3_DOF_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("Bq5N97Xnei6s9VUYKOGHCF");
...
mxArray *sf_c3_DOF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_DOF_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_DOF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c3_DOF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_DOF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_DOFInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML(0,1,4,7,0,0,0,0,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",618,-1,4724);
        _SFD_CV_INIT_EML_FCN(0,1,"ruddercoef",4724,-1,6151);
        _SFD_CV_INIT_EML_FCN(0,2,"keelcoef",6151,-1,7585);
        _SFD_CV_INIT_EML_FCN(0,3,"resistancehull",7585,-1,7883);
        _SFD_CV_INIT_EML_IF(0,1,0,4416,4430,4470,4550);
        _SFD_CV_INIT_EML_IF(0,1,1,4479,4494,-1,4546);
        _SFD_CV_INIT_EML_IF(0,1,2,5757,5771,5811,5891);
        _SFD_CV_INIT_EML_IF(0,1,3,5820,5835,-1,5887);
        _SFD_CV_INIT_EML_IF(0,1,4,7191,7205,7245,7325);
        _SFD_CV_INIT_EML_IF(0,1,5,7254,7269,-1,7321);
        _SFD_CV_INIT_EML_IF(0,1,6,7758,7773,7820,7883);
...
{
  return "vrArC9dcciQJhIzZG2b51D";
}

static void sf_opaque_initialize_c3_DOF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_DOFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
  initialize_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_DOF(void *chartInstanceVar)
{
  enable_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_DOF(void *chartInstanceVar)
{
  disable_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_DOF(void *chartInstanceVar)
{
  sf_gateway_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_DOF(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_DOF((SFc3_DOFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_DOF();/* state var info */
...
extern void sf_internal_set_sim_state_c3_DOF(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_DOF();/* state var info */
  ...
  set_sim_state_c3_DOF((SFc3_DOFInstanceStruct*)chartInfo->chartInstance,
                       mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_DOF(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_DOF(S);
}

static void sf_opaque_set_sim_state_c3_DOF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_DOF(S, st);
}

static void sf_opaque_terminate_c3_DOF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_DOFInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_DOF((SFc3_DOFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_DOF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_DOF((SFc3_DOFInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(820824146U));
  ssSetChecksum1(S,(4079214550U));
  ssSetChecksum2(S,(2448060052U));
  ssSetChecksum3(S,(2009722074U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_DOF(SimStruct *S)
{
  SFc3_DOFInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_DOFInstanceStruct *)utMalloc(sizeof
    (SFc3_DOFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_DOFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_DOF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_DOF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_DOF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_DOF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_DOF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_DOF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_DOF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_DOF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_DOF;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_DOF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_DOF;
...
void c3_DOF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_DOF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_DOF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_DOF_method_dispatcher.\n"
