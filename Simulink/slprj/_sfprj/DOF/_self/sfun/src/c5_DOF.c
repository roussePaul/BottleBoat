...
static void initialize_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void initialize_params_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void enable_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void disable_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void c5_update_debugger_state_c5_DOF(SFc5_DOFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void set_sim_state_c5_DOF(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_st);
static void finalize_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void sf_gateway_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void c5_chartstep_c5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void initSimStructsc5_DOF(SFc5_DOFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber, uint32_T c5_instanceNumber);
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData);
static real_T c5_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_alpha, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
...
static const mxArray *c5_c_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_c_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[3]);
static void c5_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_d_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_d_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[9]);
static void c5_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static const mxArray *c5_e_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_e_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
...
static const mxArray *c5_f_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_f_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
...
static void c5_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static void c5_g_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real_T c5_y[11]);
...
static const mxArray *c5_g_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static void c5_h_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance, const
  mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId,
...
static real_T c5_abs(SFc5_DOFInstanceStruct *chartInstance, real_T c5_x);
static real_T c5_log(SFc5_DOFInstanceStruct *chartInstance, real_T c5_x);
static void c5_eml_error(SFc5_DOFInstanceStruct *chartInstance);
static void c5_eml_scalar_eg(SFc5_DOFInstanceStruct *chartInstance);
static void c5_threshold(SFc5_DOFInstanceStruct *chartInstance);
static void c5_b_eml_scalar_eg(SFc5_DOFInstanceStruct *chartInstance);
static void c5_cross(SFc5_DOFInstanceStruct *chartInstance, real_T c5_a[3],
                     real_T c5_b[3], real_T c5_c[3]);
static real_T c5_atan2(SFc5_DOFInstanceStruct *chartInstance, real_T c5_y,
  real_T c5_x);
static void c5_c_eml_scalar_eg(SFc5_DOFInstanceStruct *chartInstance);
static real_T c5_mpower(SFc5_DOFInstanceStruct *chartInstance, real_T c5_a);
static void c5_b_eml_error(SFc5_DOFInstanceStruct *chartInstance);
static const mxArray *c5_h_sf_marshallOut(void *chartInstanceVoid, void
  *c5_inData);
static int32_T c5_i_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c5_mxArrayInData, const char_T *c5_varName, void *c5_outData);
static uint8_T c5_j_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance,
  const mxArray *c5_b_is_active_c5_DOF, const char_T *c5_identifier);
static uint8_T c5_k_emlrt_marshallIn(SFc5_DOFInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void c5_b_log(SFc5_DOFInstanceStruct *chartInstance, real_T *c5_x);
static void init_dsm_address_info(SFc5_DOFInstanceStruct *chartInstance);
...
static void initialize_c5_DOF(SFc5_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_DOF = 0U;
}
...
static const mxArray *get_sim_state_c5_DOF(SFc5_DOFInstanceStruct *chartInstance)
{
  ...
  c5_b_hoistedGlobal = chartInstance->c5_is_active_c5_DOF;
  ...
  mxArray *c5_st)
{
  ...
  *c5_alpha = c5_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c5_u,
    0)), "alpha");
  chartInstance->c5_is_active_c5_DOF = c5_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c5_u, 1)), "is_active_c5_DOF");
  sf_mex_destroy(&c5_u);
  c5_update_debugger_state_c5_DOF(chartInstance);
...
static void sf_gateway_c5_DOF(SFc5_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c5_sfEvent = CALL_EVENT;
  c5_chartstep_c5_DOF(chartInstance);
...
static void c5_chartstep_c5_DOF(SFc5_DOFInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c5_par, 0U, c5_g_sf_marshallOut,
    c5_g_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_M, 17U, c5_e_sf_marshallOut,
    c5_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c5_v_t, 18U, c5_c_sf_marshallOut,
    c5_b_sf_marshallIn);
  ...
  c5_par.alpha_w = 3.1415926535897931;
  ...
  c5_C_RB[0] = 0.0;
  c5_C_RB[4] = -c5_par.m * c5_r;
  c5_C_RB[8] = 0.0;
  c5_C_RB[12] = 0.0;
  c5_C_RB[1] = c5_par.m * c5_r;
  c5_C_RB[5] = 0.0;
  c5_C_RB[9] = 0.0;
  c5_C_RB[13] = 0.0;
  c5_i3 = 0;
  ...
  c5_C_A[4] = 0.0;
  c5_C_A[8] = 0.0;
  c5_C_A[12] = (-c5_par.a22 * c5_nu[1] - c5_par.a24 * c5_nu[2]) - c5_par.a26 *
    c5_nu[3];
  c5_C_A[1] = 0.0;
  c5_C_A[5] = 0.0;
  c5_C_A[9] = 0.0;
  c5_C_A[13] = c5_par.a11 * c5_nu[0];
  c5_i7 = 0;
  ...
  c5_C_A[3] = (c5_par.a22 * c5_nu[1] + c5_par.a24 * c5_nu[2]) + c5_par.a26 *
    c5_nu[3];
  c5_C_A[7] = -c5_par.a11 * c5_nu[0];
  c5_C_A[11] = 0.0;
  c5_C_A[15] = 0.0;
  ...
  c5_m_x = c5_l_x;
  c5_h_y = c5_g_y;
  c5_i_y = c5_m_x / c5_h_y;
  c5_c_A = c5_e_y;
  c5_b_log(chartInstance, &c5_c_A);
  c5_c_B = c5_i_y;
  c5_b_log(chartInstance, &c5_c_B);
  c5_n_x = c5_c_A;
  c5_j_y = c5_c_B;
  c5_o_x = c5_n_x;
  c5_k_y = c5_j_y;
  ...
  for (c5_i18 = 0; c5_i18 < 3; c5_i18++) {
    ...
    for (c5_i20 = 0; c5_i20 < 3; c5_i20++) {
      c5_n_y[c5_i19 + c5_i18] = 0.0;
      c5_i21 = 0;
      for (c5_i22 = 0; c5_i22 < 3; c5_i22++) {
        c5_n_y[c5_i19 + c5_i18] += c5_b_a[c5_i21 + c5_i18] * c5_b_b[c5_i22 +
          c5_i19];
        c5_i21 += 3;
      }
  ...
  for (c5_i30 = 0; c5_i30 < 3; c5_i30++) {
    ...
    for (c5_i32 = 0; c5_i32 < 3; c5_i32++) {
      c5_v_tb[c5_i30] += c5_n_y[c5_i31 + c5_i30] * c5_b[c5_i32];
      c5_i31 += 3;
    }
  }
  ...
  c5_b_p[1] = 0.0;
  c5_b_p[2] = c5_r;
  c5_b_par[0] = c5_par.xs;
  c5_b_par[1] = c5_par.ys;
  c5_b_par[2] = c5_par.zs;
  c5_cross(chartInstance, c5_b_p, c5_b_par, c5_b);
  for (c5_i33 = 0; c5_i33 < 3; c5_i33++) {
    c5_V_awb[c5_i33] = (c5_v_tb[c5_i33] - c5_b_V_in[c5_i33]) - c5_b[c5_i33];
  }
  ...
  c5_v_aku = -c5_b_u + c5_r * c5_par.yk;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 124);
  c5_v_akv = (-c5_v - c5_r * c5_par.xk) + c5_p * c5_par.zk;
  ...
  c5_lb_x = c5_kb_x;
  c5_q_y = c5_p_y;
  c5_v_ahv = c5_lb_x / c5_q_y;
  _SFD_EML_CALL(0U, chartInstance->c5_sfEvent, 131U);
  c5_mb_x = c5_mpower(chartInstance, c5_v_aku) + c5_mpower(chartInstance,
    c5_v_akv);
  c5_v_ah = c5_mb_x;
  if (c5_v_ah < 0.0) {
...
static const mxArray *c5_sf_marshallOut(void *chartInstanceVoid, void *c5_inData)
{
  ...
  real_T c5_u;
  const mxArray *c5_y = NULL;
  SFc5_DOFInstanceStruct *chartInstance;
  chartInstance = (SFc5_DOFInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c5_DOF_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 54, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 4);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mrdivide"), "name", "name", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 9);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("rdivide"), "name", "name", 9);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_div"), "name", "name", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("log"), "name", "name", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("realmax"), "name", "name", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mrdivide"), "name", "name", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs33), "lhs", "lhs",
                  33);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(""), "context", "context", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("cross"), "name", "name", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("atan2"), "name", "name", 35);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs39), "lhs", "lhs",
                  39);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(""), "context", "context", 40);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("mpower"), "name", "name", 40);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 42);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("ismatrix"), "name", "name", 42);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 42);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 43);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("power"), "name", "name", 43);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 43);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 47);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("floor"), "name", "name", 47);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 47);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, sf_mex_duplicatearraysafe(&c5_lhs50), "lhs", "lhs",
                  50);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(""), "context", "context", 51);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sqrt"), "name", "name", 51);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  const mxArray *c5_b_is_active_c5_DOF, const char_T *c5_identifier)
{
  ...
  c5_thisId.fIdentifier = c5_identifier;
  c5_thisId.fParent = NULL;
  c5_y = c5_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_is_active_c5_DOF),
    &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_DOF);
  return c5_y;
}
...
void sf_c5_DOF_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2523885525U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2925819829U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2110670458U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(478894723U);
}

mxArray *sf_c5_DOF_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("MWX0ymzAuk2M1ODbiUTmpE");
...
mxArray *sf_c5_DOF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_DOF_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c5_DOF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha\",},{M[8],M[0],T\"is_active_c5_DOF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_DOF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc5_DOFInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",618,-1,4555);
...
{
  return "2zHqJMYKfL2PHhZwAWMKiD";
}

static void sf_opaque_initialize_c5_DOF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc5_DOFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
  initialize_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_DOF(void *chartInstanceVar)
{
  enable_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_DOF(void *chartInstanceVar)
{
  disable_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_DOF(void *chartInstanceVar)
{
  sf_gateway_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_DOF(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_DOF((SFc5_DOFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_DOF();/* state var info */
...
extern void sf_internal_set_sim_state_c5_DOF(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c5_DOF();/* state var info */
  ...
  set_sim_state_c5_DOF((SFc5_DOFInstanceStruct*)chartInfo->chartInstance,
                       mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_DOF(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_DOF(S);
}

static void sf_opaque_set_sim_state_c5_DOF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c5_DOF(S, st);
}

static void sf_opaque_terminate_c5_DOF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_DOFInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_DOF((SFc5_DOFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_DOF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c5_DOF((SFc5_DOFInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c5_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4158077947U));
  ssSetChecksum1(S,(1492684589U));
  ssSetChecksum2(S,(25928017U));
  ssSetChecksum3(S,(264038299U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c5_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c5_DOF(SimStruct *S)
{
  SFc5_DOFInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_DOFInstanceStruct *)utMalloc(sizeof
    (SFc5_DOFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_DOFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_DOF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c5_DOF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_DOF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_DOF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_DOF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_DOF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_DOF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c5_DOF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_DOF;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_DOF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_DOF;
...
void c5_DOF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_DOF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_DOF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_DOF_method_dispatcher.\n"
