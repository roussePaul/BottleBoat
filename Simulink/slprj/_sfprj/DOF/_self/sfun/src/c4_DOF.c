...
static void initialize_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void initialize_params_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void enable_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void disable_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_DOF(SFc4_DOFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void set_sim_state_c4_DOF(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_st);
static void finalize_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void sf_gateway_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void c4_chartstep_c4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void initSimStructsc4_DOF(SFc4_DOFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_attack, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[3]);
static void c4_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[9]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_e_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_e_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[16]);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_f_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[4]);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_g_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId, real_T c4_y[11]);
...
static const mxArray *c4_g_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_h_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance, const
  mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
...
static real_T c4_abs(SFc4_DOFInstanceStruct *chartInstance, real_T c4_x);
static real_T c4_log(SFc4_DOFInstanceStruct *chartInstance, real_T c4_x);
static void c4_eml_error(SFc4_DOFInstanceStruct *chartInstance);
static void c4_eml_scalar_eg(SFc4_DOFInstanceStruct *chartInstance);
static void c4_threshold(SFc4_DOFInstanceStruct *chartInstance);
static void c4_b_eml_scalar_eg(SFc4_DOFInstanceStruct *chartInstance);
static real_T c4_atan2(SFc4_DOFInstanceStruct *chartInstance, real_T c4_y,
  real_T c4_x);
static void c4_c_eml_scalar_eg(SFc4_DOFInstanceStruct *chartInstance);
static real_T c4_mod(SFc4_DOFInstanceStruct *chartInstance, real_T c4_x, real_T
                     c4_y);
static const mxArray *c4_h_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_i_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_j_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance,
  const mxArray *c4_b_is_active_c4_DOF, const char_T *c4_identifier);
static uint8_T c4_k_emlrt_marshallIn(SFc4_DOFInstanceStruct *chartInstance,
  const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_b_log(SFc4_DOFInstanceStruct *chartInstance, real_T *c4_x);
static void init_dsm_address_info(SFc4_DOFInstanceStruct *chartInstance);
...
static void initialize_c4_DOF(SFc4_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_DOF = 0U;
}
...
static const mxArray *get_sim_state_c4_DOF(SFc4_DOFInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal = chartInstance->c4_is_active_c4_DOF;
  ...
  mxArray *c4_st)
{
  ...
  *c4_attack = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    0)), "attack");
  chartInstance->c4_is_active_c4_DOF = c4_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c4_u, 1)), "is_active_c4_DOF");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_DOF(chartInstance);
...
static void sf_gateway_c4_DOF(SFc4_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_DOF(chartInstance);
...
static void c4_chartstep_c4_DOF(SFc4_DOFInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_par, 0U, c4_g_sf_marshallOut,
    c4_g_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_M, 17U, c4_e_sf_marshallOut,
    c4_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c4_v_t, 18U, c4_c_sf_marshallOut,
    c4_b_sf_marshallIn);
  ...
  c4_par.alpha_w = 3.1415926535897931;
  ...
  c4_C_RB[0] = 0.0;
  c4_C_RB[4] = -c4_par.m * c4_r;
  c4_C_RB[8] = 0.0;
  c4_C_RB[12] = 0.0;
  c4_C_RB[1] = c4_par.m * c4_r;
  c4_C_RB[5] = 0.0;
  c4_C_RB[9] = 0.0;
  c4_C_RB[13] = 0.0;
  c4_i3 = 0;
  ...
  c4_C_A[4] = 0.0;
  c4_C_A[8] = 0.0;
  c4_C_A[12] = (-c4_par.a22 * c4_nu[1] - c4_par.a24 * c4_nu[2]) - c4_par.a26 *
    c4_nu[3];
  c4_C_A[1] = 0.0;
  c4_C_A[5] = 0.0;
  c4_C_A[9] = 0.0;
  c4_C_A[13] = c4_par.a11 * c4_nu[0];
  c4_i7 = 0;
  ...
  c4_C_A[3] = (c4_par.a22 * c4_nu[1] + c4_par.a24 * c4_nu[2]) + c4_par.a26 *
    c4_nu[3];
  c4_C_A[7] = -c4_par.a11 * c4_nu[0];
  c4_C_A[11] = 0.0;
  c4_C_A[15] = 0.0;
  ...
  c4_m_x = c4_l_x;
  c4_h_y = c4_g_y;
  c4_i_y = c4_m_x / c4_h_y;
  c4_c_A = c4_e_y;
  c4_b_log(chartInstance, &c4_c_A);
  c4_c_B = c4_i_y;
  c4_b_log(chartInstance, &c4_c_B);
  c4_n_x = c4_c_A;
  c4_j_y = c4_c_B;
  c4_o_x = c4_n_x;
  c4_k_y = c4_j_y;
  c4_p_x = c4_o_x;
  c4_l_y = c4_k_y;
  c4_m_y = c4_p_x / c4_l_y;
  c4_a = c4_m_y;
  for (c4_i10 = 0; c4_i10 < 3; c4_i10++) {
    c4_b[c4_i10] = c4_v_t[c4_i10];
  }
  ...
  for (c4_i18 = 0; c4_i18 < 3; c4_i18++) {
    ...
    for (c4_i20 = 0; c4_i20 < 3; c4_i20++) {
      c4_n_y[c4_i19 + c4_i18] = 0.0;
      c4_i21 = 0;
      for (c4_i22 = 0; c4_i22 < 3; c4_i22++) {
        c4_n_y[c4_i19 + c4_i18] += c4_b_a[c4_i21 + c4_i18] * c4_b_b[c4_i22 +
          c4_i19];
        c4_i21 += 3;
      }
  ...
  for (c4_i30 = 0; c4_i30 < 3; c4_i30++) {
    ...
    for (c4_i32 = 0; c4_i32 < 3; c4_i32++) {
      c4_v_tb[c4_i30] += c4_n_y[c4_i31 + c4_i30] * c4_b[c4_i32];
      c4_i31 += 3;
    }
  }
  ...
  c4_b[1] = c4_par.ys;
  c4_b[2] = c4_par.zs;
  c4_c1 = c4_C[1] * c4_b[2] - c4_C[2] * c4_b[1];
  c4_c2 = c4_C[2] * c4_b[0] - c4_C[0] * c4_b[2];
  c4_c3 = c4_C[0] * c4_b[1] - c4_C[1] * c4_b[0];
  c4_C[0] = c4_c1;
  c4_C[1] = c4_c2;
  c4_C[2] = c4_c3;
  for (c4_i33 = 0; c4_i33 < 3; c4_i33++) {
    c4_V_awb[c4_i33] = (c4_v_tb[c4_i33] - c4_b_V_in[c4_i33]) - c4_C[c4_i33];
  }
  ...
  c4_v_aku = -c4_b_u + c4_r * c4_par.yk;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, 125);
  c4_v_akv = (-c4_v - c4_r * c4_par.xk) + c4_p * c4_par.zk;
  ...
  c4_ib_x = c4_hb_x;
  c4_jb_x = c4_ib_x;
  c4_o_y = c4_jb_x / 3.1415926535897931;
  c4_attack = c4_o_y * 180.0;
  _SFD_EML_CALL(0U, chartInstance->c4_sfEvent, -141);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  real_T c4_u;
  const mxArray *c4_y = NULL;
  SFc4_DOFInstanceStruct *chartInstance;
  chartInstance = (SFc4_DOFInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_DOF_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("abs"), "name", "name", 4);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mrdivide"), "name", "name", 7);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("rdivide"), "name", "name", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_div"), "name", "name", 12);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("log"), "name", "name", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 17);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("realmax"), "name", "name", 17);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, sf_mex_duplicatearraysafe(&c4_lhs33), "lhs", "lhs",
                  33);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("cross"), "name", "name", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("atan2"), "name", "name", 35);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, sf_mex_duplicatearraysafe(&c4_lhs39), "lhs", "lhs",
                  39);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(""), "context", "context", 40);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("mod"), "name", "name", 40);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eps"), "name", "name", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("eml_eps"), "name", "name", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c4_info, c4_emlrt_marshallOut(
  ...
  const mxArray *c4_b_is_active_c4_DOF, const char_T *c4_identifier)
{
  ...
  c4_thisId.fIdentifier = c4_identifier;
  c4_thisId.fParent = NULL;
  c4_y = c4_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c4_b_is_active_c4_DOF),
    &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_DOF);
  return c4_y;
}
...
void sf_c4_DOF_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3200797371U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3289090438U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1300650273U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3545452501U);
}

mxArray *sf_c4_DOF_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("YqpTy7iecWrFrvY7YCCsvB");
...
mxArray *sf_c4_DOF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_DOF_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c4_DOF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c4_DOF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_DOF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_DOFInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",618,-1,4665);
        _SFD_CV_INIT_EML_IF(0,1,0,4489,4503,4543,4623);
        _SFD_CV_INIT_EML_IF(0,1,1,4552,4567,-1,4619);
...
{
  return "OPK9SKXupg5qxFom2u2AnD";
}

static void sf_opaque_initialize_c4_DOF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_DOFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
  initialize_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_DOF(void *chartInstanceVar)
{
  enable_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_DOF(void *chartInstanceVar)
{
  disable_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_DOF(void *chartInstanceVar)
{
  sf_gateway_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_DOF(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_DOF((SFc4_DOFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_DOF();/* state var info */
...
extern void sf_internal_set_sim_state_c4_DOF(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c4_DOF();/* state var info */
  ...
  set_sim_state_c4_DOF((SFc4_DOFInstanceStruct*)chartInfo->chartInstance,
                       mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_DOF(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_DOF(S);
}

static void sf_opaque_set_sim_state_c4_DOF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_DOF(S, st);
}

static void sf_opaque_terminate_c4_DOF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_DOFInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_DOF((SFc4_DOFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_DOF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c4_DOF((SFc4_DOFInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(109681102U));
  ssSetChecksum1(S,(3704602433U));
  ssSetChecksum2(S,(1120499360U));
  ssSetChecksum3(S,(1916755318U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_DOF(SimStruct *S)
{
  SFc4_DOFInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_DOFInstanceStruct *)utMalloc(sizeof
    (SFc4_DOFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_DOFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c4_DOF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c4_DOF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c4_DOF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_DOF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_DOF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c4_DOF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c4_DOF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c4_DOF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_DOF;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_DOF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_DOF;
...
void c4_DOF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_DOF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_DOF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_DOF_method_dispatcher.\n"
