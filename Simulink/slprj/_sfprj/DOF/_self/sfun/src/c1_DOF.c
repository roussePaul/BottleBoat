...
static void initialize_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void initialize_params_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void enable_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void disable_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DOF(SFc1_DOFInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void set_sim_state_c1_DOF(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_st);
static void finalize_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void sf_gateway_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void c1_chartstep_c1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void initSimStructsc1_DOF(SFc1_DOFInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_attack, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[3]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[9]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[16]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_f_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_g_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[11]);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
...
static real_T c1_abs(SFc1_DOFInstanceStruct *chartInstance, real_T c1_x);
static real_T c1_log(SFc1_DOFInstanceStruct *chartInstance, real_T c1_x);
static void c1_eml_error(SFc1_DOFInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_DOFInstanceStruct *chartInstance);
static void c1_threshold(SFc1_DOFInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_DOFInstanceStruct *chartInstance);
static void c1_cross(SFc1_DOFInstanceStruct *chartInstance, real_T c1_a[3],
                     real_T c1_b[3], real_T c1_c[3]);
static real_T c1_atan2(SFc1_DOFInstanceStruct *chartInstance, real_T c1_y,
  real_T c1_x);
static void c1_c_eml_scalar_eg(SFc1_DOFInstanceStruct *chartInstance);
static real_T c1_mod(SFc1_DOFInstanceStruct *chartInstance, real_T c1_x, real_T
                     c1_y);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_i_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_j_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_DOF, const char_T *c1_identifier);
static uint8_T c1_k_emlrt_marshallIn(SFc1_DOFInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_log(SFc1_DOFInstanceStruct *chartInstance, real_T *c1_x);
static void init_dsm_address_info(SFc1_DOFInstanceStruct *chartInstance);
...
static void initialize_c1_DOF(SFc1_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DOF = 0U;
}
...
static const mxArray *get_sim_state_c1_DOF(SFc1_DOFInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_DOF;
  ...
  mxArray *c1_st)
{
  ...
  *c1_attack = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u,
    0)), "attack");
  chartInstance->c1_is_active_c1_DOF = c1_j_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_DOF");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DOF(chartInstance);
...
static void sf_gateway_c1_DOF(SFc1_DOFInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_DOF(chartInstance);
...
static void c1_chartstep_c1_DOF(SFc1_DOFInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_par, 0U, c1_g_sf_marshallOut,
    c1_g_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_V_in, MAX_uint32_T,
    c1_b_sf_marshallOut, c1_f_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_r, 8U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_nu, 9U, c1_f_sf_marshallOut,
    c1_e_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_M, 17U, c1_e_sf_marshallOut,
    c1_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_v_t, 18U, c1_c_sf_marshallOut,
    c1_b_sf_marshallIn);
  ...
  for (c1_i18 = 0; c1_i18 < 3; c1_i18++) {
    ...
    for (c1_i20 = 0; c1_i20 < 3; c1_i20++) {
      c1_n_y[c1_i19 + c1_i18] = 0.0;
      c1_i21 = 0;
      for (c1_i22 = 0; c1_i22 < 3; c1_i22++) {
        c1_n_y[c1_i19 + c1_i18] += c1_b_a[c1_i21 + c1_i18] * c1_b_b[c1_i22 +
          c1_i19];
        c1_i21 += 3;
      }
  ...
  for (c1_i26 = 0; c1_i26 < 3; c1_i26++) {
    c1_C[c1_i26] = c1_v_tb[c1_i26];
  }

  for (c1_i27 = 0; c1_i27 < 3; c1_i27++) {
    c1_v_tb[c1_i27] = c1_C[c1_i27];
  }
  ...
  for (c1_i30 = 0; c1_i30 < 3; c1_i30++) {
    ...
    for (c1_i32 = 0; c1_i32 < 3; c1_i32++) {
      c1_v_tb[c1_i30] += c1_n_y[c1_i31 + c1_i30] * c1_b[c1_i32];
      c1_i31 += 3;
    }
  }
  ...
  c1_b_p[1] = 0.0;
  c1_b_p[2] = c1_r;
  c1_b_par[0] = c1_par.xs;
  c1_b_par[1] = c1_par.ys;
  c1_b_par[2] = c1_par.zs;
  c1_cross(chartInstance, c1_b_p, c1_b_par, c1_b);
  for (c1_i33 = 0; c1_i33 < 3; c1_i33++) {
    c1_V_awb[c1_i33] = (c1_v_tb[c1_i33] - c1_b_V_in[c1_i33]) - c1_b[c1_i33];
  }
  ...
  c1_ib_x = c1_hb_x;
  c1_jb_x = c1_ib_x;
  c1_o_y = c1_jb_x / 3.1415926535897931;
  c1_attack = c1_o_y * 180.0;
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -144);
  _SFD_SYMBOL_SCOPE_POP();
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u;
  const mxArray *c1_y = NULL;
  SFc1_DOFInstanceStruct *chartInstance;
  chartInstance = (SFc1_DOFInstanceStruct *)chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  for (c1_i51 = 0; c1_i51 < 4; c1_i51++) {
    for (c1_i52 = 0; c1_i52 < 4; c1_i52++) {
      c1_b_inData[c1_i52 + c1_i50] = (*(real_T (*)[16])c1_inData)[c1_i52 +
        c1_i50];
    }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i58 = 0; c1_i58 < 4; c1_i58++) {
    for (c1_i59 = 0; c1_i59 < 4; c1_i59++) {
      (*(real_T (*)[16])c1_outData)[c1_i59 + c1_i57] = c1_y[c1_i59 + c1_i57];
    }
  ...
  *c1_inData)
{
  ...
  for (c1_i60 = 0; c1_i60 < 4; c1_i60++) {
    c1_b_inData[c1_i60] = (*(real_T (*)[4])c1_inData)[c1_i60];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i63 = 0; c1_i63 < 4; c1_i63++) {
    (*(real_T (*)[4])c1_outData)[c1_i63] = c1_y[c1_i63];
  }
...
const mxArray *sf_c1_DOF_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("abs"), "name", "name", 4);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 4);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mrdivide"), "name", "name", 7);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 9);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("rdivide"), "name", "name", 9);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_div"), "name", "name", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 12);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("log"), "name", "name", 14);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 14);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 17);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("realmax"), "name", "name", 17);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 17);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_log.m"),
                  "context", "context", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mrdivide"), "name", "name", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 20);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("cross"), "name", "name", 34);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("atan2"), "name", "name", 35);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 35);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("mod"), "name", "name", 40);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m!floatmod"), "context",
                  "context", 48);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eps"), "name", "name", 48);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 48);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m"), "context",
                  "context", 50);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("eml_eps"), "name", "name", 50);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 50);
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
  ...
  const mxArray *c1_b_is_active_c1_DOF, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_k_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_DOF),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_DOF);
  return c1_y;
}
...
void sf_c1_DOF_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3546362040U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(98157736U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(903618297U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3245525192U);
}

mxArray *sf_c1_DOF_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("2zyvqMiALdODipGgoiiQDB");
...
mxArray *sf_c1_DOF_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_DOF_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_DOF(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"attack\",},{M[8],M[0],T\"is_active_c1_DOF\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DOF_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_DOFInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",618,-1,4820);
        _SFD_CV_INIT_EML_FCN(0,1,"sailcoef",4820,-1,6406);
        _SFD_CV_INIT_EML_FCN(0,2,"ruddercoef",6406,-1,7833);
        _SFD_CV_INIT_EML_FCN(0,3,"keelcoef",7833,-1,9267);
        _SFD_CV_INIT_EML_FCN(0,4,"resistancehull",9267,-1,9565);
        _SFD_CV_INIT_EML_IF(0,1,0,4266,4288,4315,4402);
        _SFD_CV_INIT_EML_IF(0,1,1,4315,4342,4370,4402);
        _SFD_CV_INIT_EML_IF(0,1,2,4515,4529,4569,4649);
        _SFD_CV_INIT_EML_IF(0,1,3,4578,4593,-1,4645);
        _SFD_CV_INIT_EML_IF(0,1,4,6012,6026,6066,6146);
        _SFD_CV_INIT_EML_IF(0,1,5,6075,6090,-1,6142);
        _SFD_CV_INIT_EML_IF(0,1,6,7439,7453,7493,7573);
        _SFD_CV_INIT_EML_IF(0,1,7,7502,7517,-1,7569);
        _SFD_CV_INIT_EML_IF(0,1,8,8873,8887,8927,9007);
        _SFD_CV_INIT_EML_IF(0,1,9,8936,8951,-1,9003);
        _SFD_CV_INIT_EML_IF(0,1,10,9440,9455,9502,9565);
...
{
  return "yOy4VhNAr0aVcvrzuol5bG";
}

static void sf_opaque_initialize_c1_DOF(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DOFInstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
  initialize_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DOF(void *chartInstanceVar)
{
  enable_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DOF(void *chartInstanceVar)
{
  disable_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DOF(void *chartInstanceVar)
{
  sf_gateway_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_DOF(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DOF((SFc1_DOFInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DOF();/* state var info */
...
extern void sf_internal_set_sim_state_c1_DOF(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_DOF();/* state var info */
  ...
  set_sim_state_c1_DOF((SFc1_DOFInstanceStruct*)chartInfo->chartInstance,
                       mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_DOF(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DOF(S);
}

static void sf_opaque_set_sim_state_c1_DOF(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_DOF(S, st);
}

static void sf_opaque_terminate_c1_DOF(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DOFInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DOF((SFc1_DOFInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DOF(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_DOF((SFc1_DOFInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(1661639011U));
  ssSetChecksum1(S,(1781030164U));
  ssSetChecksum2(S,(1989588636U));
  ssSetChecksum3(S,(4241661752U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_DOF(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DOF(SimStruct *S)
{
  SFc1_DOFInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_DOFInstanceStruct *)utMalloc(sizeof
    (SFc1_DOFInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_DOFInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_DOF;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_DOF;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_DOF;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_DOF;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_DOF;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_DOF;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_DOF;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_DOF;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DOF;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DOF;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_DOF;
...
void c1_DOF_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DOF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DOF(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DOF_method_dispatcher.\n"
