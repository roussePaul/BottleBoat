...
## Generated on : Mon May 04 10:53:15 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BoatModele
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = BoatModele_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BoatModele
...
INCLUDES_BUILDINFO = -I$(START_DIR)/BoatModele_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=BoatModele -DNUMST=2 -DNCSTATES=8 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
OBJS = BoatModele.o BoatModele_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_logging.o
...
%.o : $(START_DIR)/BoatModele_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/BoatModele_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
