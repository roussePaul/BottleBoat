...
void BoatModele_step(void)
{
  ...
  /* End of SignalConversion: '<S4>/TmpSignal ConversionAt SFunction Inport1' */

  /* MATLAB Function: '<S2>/MATLAB Function1' incorporates:
   *  Constant: '<S1>/Constant'
   */
  /* MATLAB Function '4DOF nonlinear sailing yacht model/BoatDynamic/MATLAB Function1': '<S4>:1' */
  ...
  b[6] = 0.0;
  b[1] = 0.0;
  b[4] = cos(-rtb_TmpSignalConversionAtSFunct[6]);
  b[7] = -sin(-rtb_TmpSignalConversionAtSFunct[6]);
  b[2] = 0.0;
  b[5] = sin(-rtb_TmpSignalConversionAtSFunct[6]);
  b[8] = cos(-rtb_TmpSignalConversionAtSFunct[6]);
  ...
  v_aku = BoatModele_P.Constant_Value[0] * cos(BoatModele_P.Constant_Value[1]) *
    alpha_as;
  v_akv = BoatModele_P.Constant_Value[0] * sin(BoatModele_P.Constant_Value[1]) *
    alpha_as;
  V_awb_idx_0 = alpha_as * 0.0;
  for (i = 0; i < 3; i++) {
    b_1[i] = b_0[i + 6] * V_awb_idx_0 + (b_0[i + 3] * v_akv + b_0[i] * v_aku);
  }

  /* '<S4>:1:62' */
  /* '<S4>:1:63' */
  /* '<S4>:1:64' */
  alpha_aw = rt_atan2d_snf((b_1[1] - rtb_TmpSignalConversionAtSFunct[9]) -
    (rtb_TmpSignalConversionAtSFunct[11] * 0.0 -
     rtb_TmpSignalConversionAtSFunct[10] * -11.58), -((b_1[0] -
  ...
  /* Lookup_n-D: '<S2>/1-D Lookup Table6'
   * About '<S2>/1-D Lookup Table6':
   *       Table size:  100
   *    Interpolation:  Spline
   *    Extrapolation:  Linear
   *   Breakpt Search:  Binary
   ...
   *  Constant: '<S1>/Constant'
   */
  /* MATLAB Function '4DOF nonlinear sailing yacht model/BoatDynamic/MATLAB Function': '<S3>:1' */
  /*  interpreted Matlab function "f.m" for the Simulink file "SailingYachtModel.slx" */
  /*  This function describes the dynamics of a 4DOF sailing yacht model */
  /*  and gives the derivative of the state X and the sail angle delta_s. */
  /*  The input vector V_in contains the system state and the control input vector.  */
  ...
  c[6] = 0.0;
  c[1] = 0.0;
  c[4] = cos(-rtb_TmpSignalConversionAtSFunct[6]);
  c[7] = -sin(-rtb_TmpSignalConversionAtSFunct[6]);
  c[2] = 0.0;
  c[5] = sin(-rtb_TmpSignalConversionAtSFunct[6]);
  c[8] = cos(-rtb_TmpSignalConversionAtSFunct[6]);
  tmp_2[0] = cos(-rtb_TmpSignalConversionAtSFunct[7]);
  tmp_2[3] = -sin(-rtb_TmpSignalConversionAtSFunct[7]);
  tmp_2[6] = 0.0;
  tmp_2[1] = sin(-rtb_TmpSignalConversionAtSFunct[7]);
  tmp_2[4] = cos(-rtb_TmpSignalConversionAtSFunct[7]);
  tmp_2[7] = 0.0;
  tmp_2[2] = 0.0;
  tmp_2[5] = 0.0;
  tmp_2[8] = 1.0;
  ...
  V_awb_idx_0 = alpha_as * 0.0;
  for (i = 0; i < 3; i++) {
    b_1[i] = b[i + 6] * V_awb_idx_0 + (b[i + 3] * v_akv + b[i] * v_aku);
  }

  V_awb_idx_0 = (b_1[0] - rtb_TmpSignalConversionAtSFunct[8]) - (-0.0 -
    rtb_TmpSignalConversionAtSFunct[11] * 0.0);
  v_aku = (b_1[1] - rtb_TmpSignalConversionAtSFunct[9]) -
    (rtb_TmpSignalConversionAtSFunct[11] * 0.0 -
  ...
  /* '<S3>:1:62' */
  /* '<S3>:1:63' */
  alpha_aw = rt_atan2d_snf(v_aku, -V_awb_idx_0);
  ...
  /* '<S3>:1:80' */
  Ls = (V_awb_idx_0 * V_awb_idx_0 + v_aku * v_aku) * 102.0 * rtb_DLookupTable;

  /* '<S3>:1:81' */
  Ds = (V_awb_idx_0 * V_awb_idx_0 + v_aku * v_aku) * 102.0 * rtb_DLookupTable4;
  ...
  /* '<S3>:1:136' */
  /* '<S3>:1:137' */
  M_0[0] = cos(rtb_TmpSignalConversionAtSFunct[7]);
  M_0[4] = -sin(rtb_TmpSignalConversionAtSFunct[7]) * cos
    (rtb_TmpSignalConversionAtSFunct[6]);
  M_0[8] = 0.0;
  M_0[12] = 0.0;
  M_0[1] = sin(rtb_TmpSignalConversionAtSFunct[7]);
  M_0[5] = cos(rtb_TmpSignalConversionAtSFunct[7]) * cos
    (rtb_TmpSignalConversionAtSFunct[6]);
  M_0[9] = 0.0;
  M_0[13] = 0.0;
  M_0[2] = 0.0;
  ...
  M_0[7] = 0.0;
  M_0[11] = 0.0;
  M_0[15] = cos(rtb_TmpSignalConversionAtSFunct[6]);
  for (i = 0; i < 4; i++) {
    v_akv = M_0[i + 12] * rtb_TmpSignalConversionAtSFunct[11] + (M_0[i + 8] *
      rtb_TmpSignalConversionAtSFunct[10] + (M_0[i + 4] *
      rtb_TmpSignalConversionAtSFunct[9] + M_0[i] *
      rtb_TmpSignalConversionAtSFunct[8]));
    eta_dot[i] = v_akv;
  }
  ...
  /* '<S3>:1:153' */
  tmp_3[0] = 0.0;
  tmp_3[4] = -25900.0 * rtb_TmpSignalConversionAtSFunct[11];
  tmp_3[8] = 0.0;
  tmp_3[12] = 0.0;
  tmp_3[1] = 25900.0 * rtb_TmpSignalConversionAtSFunct[11];
  tmp_3[5] = 0.0;
  tmp_3[9] = 0.0;
  tmp_3[13] = 0.0;
  tmp_3[2] = 0.0;
  ...
  tmp_4[4] = 0.0;
  tmp_4[8] = 0.0;
  tmp_4[12] = (-17430.0 * rtb_TmpSignalConversionAtSFunct[9] - -13160.0 *
               rtb_TmpSignalConversionAtSFunct[10]) - -6190.0 *
    rtb_TmpSignalConversionAtSFunct[11];
  tmp_4[1] = 0.0;
  tmp_4[5] = 0.0;
  tmp_4[9] = 0.0;
  tmp_4[13] = 970.0 * rtb_TmpSignalConversionAtSFunct[8];
  tmp_4[2] = 0.0;
  tmp_4[6] = 0.0;
  tmp_4[10] = 0.0;
  tmp_4[14] = 0.0;
  tmp_4[3] = (17430.0 * rtb_TmpSignalConversionAtSFunct[9] + -13160.0 *
              rtb_TmpSignalConversionAtSFunct[10]) + -6190.0 *
    rtb_TmpSignalConversionAtSFunct[11];
  tmp_4[7] = -970.0 * rtb_TmpSignalConversionAtSFunct[8];
  tmp_4[11] = 0.0;
  tmp_4[15] = 0.0;
  for (i = 0; i < 4; i++) {
    V_awb_idx_0 = tmp_3[i + 12] * rtb_TmpSignalConversionAtSFunct[11] + (tmp_3[i
  ...
  for (i = 0; i < 4; i++) {
    V_awb_idx_0 = tmp_4[i + 12] * rtb_TmpSignalConversionAtSFunct[11] + (tmp_4[i
      + 8] * rtb_TmpSignalConversionAtSFunct[10] + (tmp_4[i + 4] *
      rtb_TmpSignalConversionAtSFunct[9] + tmp_4[i] *
      rtb_TmpSignalConversionAtSFunct[8]));
    tmp_6[i] = V_awb_idx_0;
  }
  ...
  BoatModele_mldivide(M_0, nu_dot);
  e[0] = (-Lk * sin(alpha_ak) + alpha_as * cos(alpha_ak)) + rtb_DLookupTable3 *
    cos(v_aku);
  e[1] = (-Lk * cos(alpha_ak) - alpha_as * sin(alpha_ak)) + -rtb_DLookupTable3 *
    sin(v_aku) * cos(rtb_TmpSignalConversionAtSFunct[6]);
  e[2] = (-(-Lk * cos(alpha_ak) - alpha_as * sin(alpha_ak)) * -0.58 +
          rtb_DLookupTable3 * sin(v_aku) * cos(rtb_TmpSignalConversionAtSFunct[6])
          * -1.18) + 120000.0 * eta_dot[2] * fabs(eta_dot[2]);
  e[3] = (-(Lk * cos(alpha_ak) + alpha_as * sin(alpha_ak)) * 0.0 +
          -rtb_DLookupTable3 * sin(v_aku) * cos(rtb_TmpSignalConversionAtSFunct
           [6]) * 0.0) + 50000.0 * eta_dot[3] * fabs(eta_dot[3]) * cos
    (rtb_TmpSignalConversionAtSFunct[6]);
  BoatModele_mldivide(M, e);
  nu[0] = 0.0;
  nu[1] = 0.0;
  ...
  BoatModele_B.X_dot_ext[7] = ((nu_dot[3] - e[3]) - nu[3]) + D_hull[3];
...
void BoatModele_initialize(void)
{
  ...
  /* Start for Lookup_n-D: '<S2>/1-D Lookup Table6' */
  {
