...
static void initialize_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void initialize_params_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void enable_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct *chartInstance);
static void disable_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_BoatDynamic
  (SFc1_BoatDynamicInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_BoatDynamic
  (SFc1_BoatDynamicInstanceStruct *chartInstance);
static void set_sim_state_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void sf_gateway_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void initSimStructsc1_BoatDynamic(SFc1_BoatDynamicInstanceStruct
  *chartInstance);
static void c1_modeleBoat(SFc1_BoatDynamicInstanceStruct *chartInstance,
  c1_srLgvkCzuuZn3rWrmrpDanB *c1_par);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_alpha_hull, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[3]);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[9]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[16]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_f_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_g_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[12]);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct *chartInstance,
...
static real_T c1_abs(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T c1_x);
static real_T c1_log(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T c1_x);
static void c1_eml_error(SFc1_BoatDynamicInstanceStruct *chartInstance);
static void c1_eml_scalar_eg(SFc1_BoatDynamicInstanceStruct *chartInstance);
static void c1_threshold(SFc1_BoatDynamicInstanceStruct *chartInstance);
static void c1_b_eml_scalar_eg(SFc1_BoatDynamicInstanceStruct *chartInstance);
static real_T c1_atan2(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T
  c1_y, real_T c1_x);
static void c1_c_eml_scalar_eg(SFc1_BoatDynamicInstanceStruct *chartInstance);
static real_T c1_mod(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T c1_x,
                     real_T c1_y);
static real_T c1_mpower(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T
  c1_a);
static void c1_b_eml_error(SFc1_BoatDynamicInstanceStruct *chartInstance);
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_i_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_j_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_BoatDynamic, const char_T
  *c1_identifier);
static uint8_T c1_k_emlrt_marshallIn(SFc1_BoatDynamicInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_log(SFc1_BoatDynamicInstanceStruct *chartInstance, real_T *c1_x);
static void init_dsm_address_info(SFc1_BoatDynamicInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_BoatDynamic = 0U;
}
  ...
  (SFc1_BoatDynamicInstanceStruct *chartInstance)
{
  ...
  c1_e_hoistedGlobal = chartInstance->c1_is_active_c1_BoatDynamic;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_attack_sail = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c1_u, 3)), "attack_sail");
  chartInstance->c1_is_active_c1_BoatDynamic = c1_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 4)),
     "is_active_c1_BoatDynamic");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_BoatDynamic(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_BoatDynamic(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_BoatDynamicInstanceStruct *chartInstance;
  chartInstance = (SFc1_BoatDynamicInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_BoatDynamic_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut(
    "[E]/afs/kth.se/home/r/o/rousse/Documents/BottleBoat/Simulink/Simu/ExtraFunction/modeleBoat.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c1_info, c1_b_emlrt_marshallOut(1431523419U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_BoatDynamic), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_BoatDynamic);
  return c1_y;
}
...
void sf_c1_BoatDynamic_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_BoatDynamic_get_autoinheritance_info(void)
{
...
mxArray *sf_c1_BoatDynamic_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_BoatDynamic_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_BoatDynamic(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[8],T\"alpha_hull\",},{M[1],M[7],T\"attack_keel\",},{M[1],M[6],T\"attack_rudder\",},{M[1],M[5],T\"attack_sail\",},{M[8],M[0],T\"is_active_c1_BoatDynamic\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_BoatDynamic_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_BoatDynamicInstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_BoatDynamic(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*)
    chartInstanceVar);
  initialize_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_BoatDynamic(void *chartInstanceVar)
{
  enable_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_BoatDynamic(void *chartInstanceVar)
{
  disable_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_BoatDynamic(void *chartInstanceVar)
{
  sf_gateway_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_BoatDynamic(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_BoatDynamic
    ((SFc1_BoatDynamicInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_BoatDynamic();/* state var info */
...
extern void sf_internal_set_sim_state_c1_BoatDynamic(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_BoatDynamic();/* state var info */
  ...
  set_sim_state_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_BoatDynamic(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_BoatDynamic(S);
}

static void sf_opaque_set_sim_state_c1_BoatDynamic(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_BoatDynamic(S, st);
}

static void sf_opaque_terminate_c1_BoatDynamic(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_BoatDynamic((SFc1_BoatDynamicInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_BoatDynamic(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_BoatDynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(851672689U));
  ssSetChecksum1(S,(2303355683U));
  ssSetChecksum2(S,(2436404268U));
  ssSetChecksum3(S,(3999014247U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_BoatDynamic(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_BoatDynamic(SimStruct *S)
{
  SFc1_BoatDynamicInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_BoatDynamicInstanceStruct *)utMalloc(sizeof
    (SFc1_BoatDynamicInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_BoatDynamicInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_BoatDynamic;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_BoatDynamic;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_BoatDynamic;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_BoatDynamic;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_BoatDynamic;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_BoatDynamic;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_BoatDynamic;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_BoatDynamic;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_BoatDynamic;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_BoatDynamic;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_BoatDynamic;
...
void c1_BoatDynamic_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_BoatDynamic(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_BoatDynamic(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_BoatDynamic(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_BoatDynamic_method_dispatcher.\n"
